...
### Future candidates
  ...
  · `List.Nodup` ↔ recursive Clause 4 at the list-index level — a
    list has no duplicates iff no two distinct index positions hold
    the same element (the no-self-pair axiom read at list
