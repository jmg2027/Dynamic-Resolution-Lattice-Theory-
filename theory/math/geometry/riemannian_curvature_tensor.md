...
`𝓦`-monotonicity) is the open frontier, tracked under the ricci-flow
smooth-core topic in `research-notes/frontiers/`.
...
**analysis**, tracked under the ricci-flow smooth-core topic in
