...
- `lean/E213/Lib/Math/NumberSystems/Real213/Phi/ZeckendorfCarry.lean` (7 PURE, 0 DIRTY) — the golden
...
| `golden_adic_carry` | `Real213/Phi/ZeckendorfCarry` | the golden/Zeckendorf carry `011→100` = Fibonacci recurrence, value-preserving; admissibility = Cassini |
...
```bash
cd lean && lake build E213.Theory.Raw.Odometer E213.Lib.Math.NumberSystems.Real213.Phi.ZeckendorfCarry
