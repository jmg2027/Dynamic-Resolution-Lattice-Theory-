...
| `gra_universality_one_principle.md` | Walk-length, cup-length, truncation, chromatic height, resolution exponent — why are these the same? | `math/gra_book.md` + `math/graded_residue_arithmetic.md` + `lean/E213/Lib/Math/GRA/` umbrella + `GRA/Translation.lean` |
