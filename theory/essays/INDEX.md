...
The 45 essays are grouped into nine thematic sub-directories — distinct
...
| `every_axis_sees_p.md` | Why does every framework-internal reading of the atomic signature land on `{NS, NT, det} = {3, 2, 1}` and its derived quantities? | 55-axis cross-domain table; `lean/E213/Lib/Math/Algebra/Mobius213/Px/` + `theory/math/mobius213_p_orbit_closure.md` + `Mobius213GrandUnification` |
