import E213.Atomicity

/-!
# Pair Forcing: (2, 3) is the unique coprime pair with a unique atomic n

This file strengthens `E213.Atomicity.atomic_iff_five` to the
...
`E213.Atomicity.atomic_iff_five`.
-/

namespace E213.PairForcing
...
/-- The specialization `(p, q) = (2, 3)` of `Atomic` coincides with
    `E213.Atomicity.Atomic`. -/
theorem atomic_23_eq (n : Nat) :
    Atomic 2 3 n ↔ E213.Atomicity.Atomic n := by
  unfold Atomic E213.Atomicity.Atomic Decomp E213.Atomicity.Decomp
         IsAlive E213.Atomicity.IsAlive
  rfl
...
theorem atomic_23_iff_five (n : Nat) : Atomic 2 3 n ↔ n = 5 := by
  rw [atomic_23_eq]
  exact E213.Atomicity.atomic_iff_five n
