...
| θ_QCD | α⁶sin(π/12)≈5.4×10⁻¹¹ | <1.8×10⁻¹⁰ | nEDM next-gen | 2027-30 |
...
PRD_006: θ_QCD precision derivation                   7/7
```

## Status: ACTIVE
총 32/32 checks passed. 6개 실험 완료.
다음: proton decay lifetime, neutron star EOS 예측 추가 가능.
