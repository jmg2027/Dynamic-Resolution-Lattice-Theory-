...
$m_\mu/m_e$ & $\frac{n_A}{n_B\alpha}(1+\agut/4)$
  & 206.80 & 206.768 & 0.02\% \\
$m_\tau/m_\mu$ & $c^{n_A} n_B (1+x+x^2)$
  & 16.816 & 16.817 & 0.006\% \\
$m_H$ & $v_H / \sqrt{2(1+\agut)}$
  & 125 GeV & 125.25 GeV & 0.2\% \\
\bottomrule
\end{tabular}
\end{center}
...
$\eta_B$ & $6.13 \times 10^{-10}$
  & $6.12 \times 10^{-10}$ & 0.2\% \\
$\Omega_\Lambda$ & 0.6817 & 0.685 & 0.07\% \\
...
\midrule
$1/\alpha_{\mathrm{em}}$
  & 137.064 & 137.036 & 0.020\%
  & \S\ref{sec:ew} \\
$m_p$ & 938.27 MeV & 938.27 MeV & 0.000\%
  & \S\ref{sec:masses} \\
$m_\mu/m_e$ & 206.80 & 206.768 & 0.02\%
  & \S\ref{sec:masses} \\
...
\textbf{0.07\%}, with zero free parameters.
