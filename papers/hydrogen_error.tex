...
\begin{abstract}
The DRLT \emph{combinatorial} prediction for the hydrogen ground state energy, $E_1 = -12.9\;\text{eV}$, differs from the observed $-13.606\;\text{eV}$ by 5.1\%. We show that this discrepancy decomposes \emph{exactly} into four topological and QED contributions: (1) the first-generation $\det(G_h)$ geometric weight on $m_e$ (4.1\%), (2) QED vacuum polarization running of $\alpha_\text{em}$ from $M_Z$ to $Q = 0$ (1.1\%), (3) the second-order $\det(G_h)$ contribution to $m_e$ (0.2\%), and (4) reduced mass and QED higher-order effects (0.04\%). Using the \emph{full} topological values from the start gives $E_1 = -13.606\;\text{eV}$ directly. The apparent 5.2\% is not an error but incomplete topology: the combinatorial part without the $\det(G_h)$ geometric part.
\end{abstract}
...
%=====================================================================
\section{Level 1: The $m_e$ $\det(G_h)$ Contribution ($-5.2\% \to -1.3\%$)}
%=====================================================================
...
%=====================================================================
\section{Level 3: Second-Order $\det(G_h)$ ($-0.21\% \to -0.04\%$)}
%=====================================================================
...
Each topological level is suppressed relative to the previous by $\sim\!\alpha_\text{GUT} \approx 1/41$, consistent with $\det(G_h)$ contributions being perturbative in $\alpha_\text{GUT}$.
