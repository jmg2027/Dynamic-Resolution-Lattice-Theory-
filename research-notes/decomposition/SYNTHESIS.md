...
log; `practice/*.md` = the 138 worked decompositions; `FRONTIER_AUDIT.md` = the honesty pass;
...
deliverable. The headline finding, after **138 worked decompositions across ~16 disciplines**, is that this
...
The 138 decompositions converge on **two load-bearing invariants** plus **one structured frame** (the
