...
log; `practice/*.md` = the 132 worked decompositions; `FRONTIER_AUDIT.md` = the honesty pass;
...
deliverable. The headline finding, after **132 worked decompositions across ~16 disciplines**, is that this
...
The 132 decompositions converge on **two load-bearing invariants** plus **one structured frame** (the
