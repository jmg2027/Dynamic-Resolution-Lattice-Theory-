...
`determinant_closure_synthesis.md`).  This note investigates the *determinant-free* lead — power sums + Newton's identities
...
## Anchors
  ...
  - Companion (determinant program, closed): `research-notes/frontiers/determinant_closure_synthesis.md`.
