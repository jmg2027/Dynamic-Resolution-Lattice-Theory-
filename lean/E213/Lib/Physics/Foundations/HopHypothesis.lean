...
theorem strong_inv_coupling : E213.Lib.Physics.AlphaEM.Bare.inv_alpha_3 = 8 := by decide

/-- α_2 weak: 1/α_2 = 12·NT·S(NT) = 30. -/
theorem weak_inv_coupling : E213.Lib.Physics.AlphaEM.Bare.inv_alpha_2 = 30 := by decide
