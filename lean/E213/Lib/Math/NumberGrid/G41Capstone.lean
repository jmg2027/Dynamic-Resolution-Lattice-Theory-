...
/-- ★ **Joint axis saturation** at index 25 on d=5. -/
theorem joint_saturation_witness :
    levelDim 25 = 33554432
    ∧ fsmGradeStates 25 = 298023223876953125
    ∧ gridSize = 625 := joint_saturation

/-- ★★★ **Total witness** ★★★ — 2D grid: vertical CD level,
    horizontal FSM grade, both saturate at 25, total 625 cells. -/
