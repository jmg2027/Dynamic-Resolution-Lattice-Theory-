...
import E213.Lib.Math.Algebra.Linalg213.Gap.Determinant
import E213.Lib.Math.Algebra.Linalg213.Gap.TensorProduct
import E213.Lib.Math.Algebra.Linalg213.Gap.Eigen
...
namespace E213.Lib.Math.Algebra.Linalg213.Gap.Capstone

open E213.Lib.Math.Algebra.Linalg213.Gap.MatrixMul
  (Mat identityMat zeroMat matMul_zero_dim zero_mul_any)
open E213.Lib.Math.Algebra.Linalg213.Gap.Determinant
  (det2_pos det2_neg det2_mag det2_pos_identity det2_neg_identity
   det2_mag_identity det2_pos_zero)
open E213.Lib.Math.Algebra.Linalg213.Gap.TensorProduct
  (tensorDim d5_tensor tensor_one_left tensor_comm)
open E213.Lib.Math.Algebra.Linalg213.Gap.Eigen
...
theorem total_witness (lam v0 m n : Nat) (A B : Mat) (i j : Nat) :
    ...
    E213.Lib.Math.Algebra.Linalg213.Gap.MatrixMul.matrixMulNum 0 A B i j = 0
    ∧ E213.Lib.Math.Algebra.Linalg213.Gap.MatrixMul.matrixMulNum 3 zeroMat B i j = 0
    -- Determinant
    ...
    -- Eigenvalue
    ∧ E213.Lib.Math.Algebra.Linalg213.Gap.MatrixMul.matrixMulNum 1
        (E213.Lib.Math.Algebra.Linalg213.Gap.Eigen.scalarMat lam)
...
end E213.Lib.Math.Algebra.Linalg213.Gap.Capstone
