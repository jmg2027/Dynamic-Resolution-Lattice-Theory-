...
`C`, `D` with asymptotes in `ℤ[√5]` (`Lib/Math/Algebra/CayleyDickson/
...
namespace E213.Lib.Math.Algebra.CayleyDickson.Tower.Mobius213CDBridge
...
end E213.Lib.Math.Algebra.CayleyDickson.Tower.Mobius213CDBridge
