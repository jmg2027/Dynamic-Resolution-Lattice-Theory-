...
import E213.Lib.Math.Algebra.CayleyDickson.Misc.TypeAResidualClosedForm
...
import E213.Lib.Math.Algebra.CayleyDickson.Integer.ZOmegaDouble
import E213.Lib.Math.Algebra.CayleyDickson.Integer.ZOmegaQuad
import E213.Lib.Math.Algebra.CayleyDickson.Integer.Hurwitz213
import E213.Lib.Math.Algebra.CayleyDickson.Integer.ZOmegaOct
...
import E213.Lib.Math.Algebra.CayleyDickson.Misc.TypeE_Rejection
import E213.Lib.Math.Algebra.CayleyDickson.Tower.UniversalInduction
...
import E213.Lib.Math.Algebra.CayleyDickson.Tower.TowerFixedPoint
...
namespace E213.Lib.Math.Algebra.CayleyDickson.Tower.AlgebraTowerCapstone

/-- Sentinel: this capstone imports all algebra-tower discovery files. -/
theorem capstone_loaded : True := trivial

end E213.Lib.Math.Algebra.CayleyDickson.Tower.AlgebraTowerCapstone
