...
namespace E213.Lib.Math.Algebra.CayleyDickson.Levels.PathionHeavy


open E213.Lib.Math.Algebra.CayleyDickson.Integer.ZI
open E213.Lib.Math.Algebra.CayleyDickson.Integer.ZI.ZI
open E213.Lib.Math.Algebra.CayleyDickson.Levels.Pathion
open E213.Lib.Math.Algebra.CayleyDickson.Levels.Pathion.Pathion
open E213.Lib.Math.Algebra.CayleyDickson.Levels.Trigintaduonion
open E213.Lib.Math.Algebra.CayleyDickson.Levels.Trigintaduonion.Trigintaduonion
...
private theorem sedenion_neg_neg
    (u : E213.Lib.Math.Algebra.CayleyDickson.Levels.Sedenion.Sedenion) :
    -(-u) = u := by
  apply E213.Lib.Math.Algebra.CayleyDickson.Levels.Sedenion.Sedenion.ext
...
theorem conj_conj (u : Pathion) : conj (conj u) = u := by
  ...
  · show u.re.conj.conj = u.re
    exact E213.Lib.Math.Algebra.CayleyDickson.Levels.TrigintaduoionionHeavy.conj_conj u.re
  · show -(-u.im) = u.im
    exact trigintaduonion_neg_neg u.im

end E213.Lib.Math.Algebra.CayleyDickson.Levels.PathionHeavy
