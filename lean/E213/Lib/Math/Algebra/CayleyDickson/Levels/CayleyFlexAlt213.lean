import E213.Lib.Math.Algebra.CayleyDickson.Levels.CayleyMoufang
...
theorem cay_conj_mul_self (a : Cayley) :
    Cayley.conj a * a = ofInt (E213.Lib.Math.Algebra.CayleyDickson.Levels.CayleyHeavy.normSq a) := by
  apply toCDDouble_inj
...
instance : FlexAlt213 Cayley where
  ...
  alt_left      := E213.Lib.Math.Algebra.CayleyDickson.Levels.CayleyHeavy.alt_left
  alt_right     := E213.Lib.Math.Algebra.CayleyDickson.Levels.CayleyHeavy.alt_right
  flexible      := E213.Lib.Math.Algebra.CayleyDickson.Levels.CayleyHeavy.flexible
