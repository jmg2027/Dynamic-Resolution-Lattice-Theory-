...
import E213.Lib.Math.Algebra.CayleyDickson.Levels.SedenionAlgebra213
...
namespace E213.Lib.Math.Algebra.CayleyDickson.Levels.TrigintaduoionionHeavy
...
theorem conj_conj (u : Trigintaduonion) : conj (conj u) = u := by
  ...
  · show u.re.conj.conj = u.re
    exact E213.Lib.Math.Algebra.CayleyDickson.Levels.SedenionHeavy.conj_conj u.re
  · show -(-u.im) = u.im
...
end E213.Lib.Math.Algebra.CayleyDickson.Levels.TrigintaduoionionHeavy
