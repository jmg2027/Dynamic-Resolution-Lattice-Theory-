...
def ofInt (n : Int) : L3T :=
  ⟨E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ofInt 2 n, 0⟩
...
private theorem zsqrt_ofInt_conj_self (n : Int) :
    ZSqrt.conj (E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ofInt 2 n) = E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ofInt 2 n := by
  apply ZSqrt.ext
  · show n = n; rfl
  · show -(0 : Int) = 0; rfl
...
private theorem ofInt_add' (a b : Int) :
  ...
  apply L3T_ext
  · unfold ofInt
    change (E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ofInt 2 a
          + E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ofInt 2 b
          = E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ofInt 2 (a + b))
