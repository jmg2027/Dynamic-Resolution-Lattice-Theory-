...
import E213.Lib.Math.Algebra.CayleyDickson.Misc.QuadIdentities
import E213.Meta.Int213.Core

open E213.Meta.Nat
open E213.Meta.Nat.IntHelpers
open E213.Lib.Math.Algebra.CayleyDickson.Misc.QuadIdentities
...
namespace E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ZSqrt
...
theorem normSq_nonneg (hD : 0 ≤ D) (u : ZSqrt D) :
  ...
  have h3 : 0 ≤ D * (u.im * u.im) :=
    E213.Meta.Int213.mul_nonneg hD h2
  exact E213.Meta.Int213.add_nonneg h1 h3
...
theorem normSq_eq_zero_iff (hD : 0 < D) (u : ZSqrt D) :
  ...
  · intro h
    ...
    have h3 : 0 ≤ D * (u.im * u.im) :=
      E213.Meta.Int213.mul_nonneg hDnn h2
    obtain ⟨hre, hd_im⟩ :=
      E213.Meta.Int213.add_eq_zero_of_nonneg h1 h3 h_eq
    have him : u.im * u.im = 0 := by
      rcases E213.Meta.Int213.mul_eq_zero hd_im with hD0 | h
...
theorem no_zero_div (hD : 0 < D) (u v : ZSqrt D) :
  ...
  have hn : (u * v).normSq = 0 := by
    rw [huv]
    show (0 : Int) * 0 + D * (0 * 0) = 0
    rw [Int.mul_zero, Int.mul_zero, E213.Meta.Int213.zero_add]
  rw [normSq_mul] at hn
...
end E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ZSqrt
