...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3
...
end E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3
...
/-- Pad ArithFSM₂(n) into ArithFSM₃(n) by adding an inert third
    ...
    `E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.ArithFSM2`) so that dot
