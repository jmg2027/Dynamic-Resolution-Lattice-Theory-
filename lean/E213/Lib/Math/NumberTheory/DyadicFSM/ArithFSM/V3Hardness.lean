...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3Hardness
open E213.Lib.Math.NumberTheory.DyadicFSM.Tier.Tier2Hardness (aperiodic_bits_imp_not_BitFSM BitFSM_generable_imp_eventually_periodic)
...
end E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3Hardness
