...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.Pell.ProperBridge

open E213.Lib.Math.NumberTheory.DyadicFSM.Legendre.V213 (legendre213)
open E213.Lib.Math.NumberTheory.DyadicFSM.Pell.Proper (pellProperFSMmod pisano_predict_proper)
...
theorem legendre_8_mod_5 :
    legendre213 8 5 (by decide) = ⟨2, by decide⟩ := by decide
...
end E213.Lib.Math.NumberTheory.DyadicFSM.Pell.ProperBridge
