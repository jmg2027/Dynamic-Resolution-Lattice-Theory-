...
All theorems at PURE (∅-axiom; verified).
-/

namespace E213.Lib.Math.NumberTheory.DyadicFSM.Forward.ForwardEventual
...
open E213.Lib.Math.NumberTheory.DyadicFSM.Forward.ForwardClosure (sub_is_multiple_of_p)
...
end E213.Lib.Math.NumberTheory.DyadicFSM.Forward.ForwardEventual
