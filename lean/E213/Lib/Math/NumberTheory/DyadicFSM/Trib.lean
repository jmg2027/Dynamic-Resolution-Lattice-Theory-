import E213.Lib.Math.NumberTheory.DyadicFSM.Trib.CRTCapstone
import E213.Lib.Math.NumberTheory.DyadicFSM.Trib.FSMmod
import E213.Lib.Math.NumberTheory.DyadicFSM.Trib.Capstone

/-! Spec-as-code entry point for `E213.Lib.Math.NumberTheory.DyadicFSM.Trib`.
