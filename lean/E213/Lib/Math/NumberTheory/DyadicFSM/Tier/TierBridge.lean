...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.Tier.TierBridge
...
theorem bit13_period_2 (k : Nat) : bit13 (k + 2) = bit13 k := by
  show ((k + 2) % 2 == 1) = (k % 2 == 1)
  rw [E213.Meta.Nat.NatDiv213.add_mod_right_pos (by decide : 0 < 2) k]
...
(Available via `Lib.Math.Combinatorics.Pigeonhole.no_inj_lt`; full formalisation
is the natural next step.) -/

end E213.Lib.Math.NumberTheory.DyadicFSM.Tier.TierBridge
