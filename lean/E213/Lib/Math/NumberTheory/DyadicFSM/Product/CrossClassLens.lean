...
import E213.Lib.Math.NumberTheory.DyadicFSM.Pell.LensCompositions
...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.Product.CrossClassLens
...
open E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3 (tribFSMmod2 tribFSMmod2_bits_period_4)
open E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3Bound (toBitFSM3_bits_eq)
open E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3toBitFSM
open E213.Lib.Math.NumberTheory.DyadicFSM.Pell.LensCompositions
...
open E213.Lib.Math.NumberTheory.DyadicFSM.Product.ProductFSMPeriodDvd (lens_composition_period_dvd)


/-- Lifted bit periodicity for Tribonacci mod 2 (BitFSM form). -/
theorem tribMod2_BitFSM_bits_period_4 :
    ∀ k, (E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3toBitFSM.ArithFSM3.toBitFSM
            (by decide : (0:Nat) < 2) tribFSMmod2).bits (k + 4)
        = (E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3toBitFSM.ArithFSM3.toBitFSM
            (by decide : (0:Nat) < 2) tribFSMmod2).bits k :=
  E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V3Bound.toBitFSM3_bits_period_lift
...
end E213.Lib.Math.NumberTheory.DyadicFSM.Product.CrossClassLens
