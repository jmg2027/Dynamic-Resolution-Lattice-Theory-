...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.Product.ProductFSM

open E213.Lib.Math.NumberTheory.DyadicFSM.ArithFSM.V1 (ArithFSM1)
open E213.Lib.Math.NumberTheory.DyadicFSM.BitFSM (BitFSM)
open E213.Lib.Math.NumberTheory.DyadicFSM.Product.ProductHelpers (encodeFinPair decodeFinFirst decodeFinSecond)
...
end E213.Lib.Math.NumberTheory.DyadicFSM.Product.ProductFSM
