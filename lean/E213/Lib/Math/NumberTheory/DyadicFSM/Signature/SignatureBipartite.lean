...
namespace E213.Lib.Math.NumberTheory.DyadicFSM.Signature.SignatureBipartite
...
private theorem succ_mod_two (k : Nat) : (k + 1) % 2 = (k % 2 + 1) % 2 :=
  E213.Meta.Nat.AddMod213.add_mod_left (by decide : 0 < 2) k 1
...
end E213.Lib.Math.NumberTheory.DyadicFSM.Signature.SignatureBipartite
