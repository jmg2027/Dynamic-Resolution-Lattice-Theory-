...
import E213.Lib.Math.CascadeCalculus.Instance

/-! Spec-as-code entry point for `E213.Lib.Math.CascadeCalculus`.
  ...
  ## Files
    ...
    * `Core`     — cascade-calculus type + ops (locality, aggregation,
                   terminals, depth)
    * `Instance` — concrete instance(s) of the cascade-calculus spec
-/
