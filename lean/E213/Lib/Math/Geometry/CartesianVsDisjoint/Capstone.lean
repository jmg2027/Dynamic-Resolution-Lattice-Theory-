...
namespace E213.Lib.Math.Geometry.CartesianVsDisjoint.Capstone

open E213.Lib.Math.Geometry.CartesianVsDisjoint.CartesianCheck
  (cartesian_product_eq six_pow_25 five_pow_25
   cartesian_overshoots cartesian_neq_binomial sandwich_bound)
open E213.Lib.Math.Geometry.CartesianVsDisjoint.DisjointVsProduct
...
end E213.Lib.Math.Geometry.CartesianVsDisjoint.Capstone
