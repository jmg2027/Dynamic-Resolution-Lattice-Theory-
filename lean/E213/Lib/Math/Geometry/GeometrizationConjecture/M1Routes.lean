...
theorem chartBase_K32_derived_from_triangle_iteration :
    chartBase 3 2
      = E213.Lib.Math.Geometry.GenerationRule.TriangleIteration.triIter 2 1
        + E213.Lib.Math.Geometry.GenerationRule.TriangleIteration.triIter 2 0 := by
...
theorem NS_NT_derived_from_atomicity_two :
    (3 : Nat) = E213.Lib.Math.Geometry.GenerationRule.TriangleIteration.triIter 2 1
    ∧ (2 : Nat) = E213.Lib.Math.Geometry.GenerationRule.TriangleIteration.triIter 2 0 :=
  ⟨E213.Lib.Math.Geometry.GenerationRule.TriangleIteration.triIter_2_1.symm,
   E213.Lib.Math.Geometry.GenerationRule.TriangleIteration.triIter_2_0.symm⟩
