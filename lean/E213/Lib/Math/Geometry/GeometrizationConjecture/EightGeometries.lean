...
theorem K32_filled_not_S3 :
    ...
    ∧ E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_boundary = 0
    -- They are NOT equal
    ∧ ((5 : Int) - 12 + 3) ≠ E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_boundary := by
  refine ⟨?_, ?_, ?_⟩
  · decide
  · exact E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_eq_zero
  · rw [E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_eq_zero]
    decide
...
theorem delta_4_ambient_containment :
    ...
    ∧ E213.Lib.Math.Geometry.Topology.EulerChi.chi_K_32_c2
        ≠ E213.Lib.Math.Geometry.Topology.EulerChi.chi_delta_4
    ∧ E213.Lib.Math.Geometry.Topology.EulerChi.chi_delta_4
        ≠ E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_boundary := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · exact E213.Lib.Math.Geometry.Topology.EulerChi.chi_K_32_c2_eq
  · exact E213.Lib.Math.Geometry.Topology.EulerChi.chi_delta_4_eq_one
  · exact E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_eq_zero
  · rw [E213.Lib.Math.Geometry.Topology.EulerChi.chi_K_32_c2_eq,
        E213.Lib.Math.Geometry.Topology.EulerChi.chi_delta_4_eq_one]
    decide
  · rw [E213.Lib.Math.Geometry.Topology.EulerChi.chi_delta_4_eq_one,
        E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_eq_zero]
    decide
...
theorem S2_partial_via_delta_3_boundary :
    ...
    ∧ chi_S2_boundary_via_delta_3 - E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_boundary = 2 := by
  refine ⟨?_, ?_, ?_⟩
  · decide
  · exact E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_eq_zero
  · rw [E213.Lib.Math.Geometry.Topology.EulerChi.chi_S3_eq_zero]
