import E213.Lib.Math.Geometry.BipartiteDecomp.AdditiveCheck
import E213.Lib.Math.Geometry.BipartiteDecomp.BinomialExpansion
...
namespace E213.Lib.Math.Geometry.BipartiteDecomp.Capstone

open E213.Lib.Math.Geometry.BipartiteDecomp.AdditiveCheck
  (substrate_sum substrate_product three_pow_25 two_pow_25
   five_pow_25 naive_sum additive_fails)
open E213.Lib.Math.Geometry.BipartiteDecomp.BinomialExpansion
  (binomial_closure first_term last_term edge_sum)
open E213.Lib.Math.Geometry.BipartiteDecomp.TernaryBinary
...
end E213.Lib.Math.Geometry.BipartiteDecomp.Capstone
