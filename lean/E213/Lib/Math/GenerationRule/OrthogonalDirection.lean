...
namespace E213.Lib.Math.GenerationRule.OrthogonalDirection
...
theorem generation_count_match :
    E213.Lib.Math.GenerationRule.GenerationCount.binom 3 2 = 3 := rfl

end E213.Lib.Math.GenerationRule.OrthogonalDirection
