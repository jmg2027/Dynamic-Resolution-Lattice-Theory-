...
import E213.Lib.Math.Real213.ExpLog.CutLogODE
...
namespace E213.Lib.Math.Real213.ExpLog.CutLogCapstone

open E213.Lib.Math.Real213.ExpLog.CutLogSeries
  (cutLog logPartialSum logTermAt logPartialSum_zero cutLog_zero
   logPartialSum_succ logTermAt_zero)
open E213.Lib.Math.Real213.ExpLog.CutLogODE
...
theorem inverse_witness (x : Nat → Nat → Bool) :
    E213.Lib.Math.Real213.ExpLog.CutExpSeries.cutExp x 0 = constCut 0 1
    ∧ cutLog x 0 = constCut 0 1
...
end E213.Lib.Math.Real213.ExpLog.CutLogCapstone
