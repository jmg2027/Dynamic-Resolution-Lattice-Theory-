...
namespace E213.Lib.Math.Real213.ExpLog.GeomSeriesCauchy
...
open E213.Lib.Math.Real213.ExpLog.CutLogODE (geomTermAt geomPartialSum)
...
end E213.Lib.Math.Real213.ExpLog.GeomSeriesCauchy
