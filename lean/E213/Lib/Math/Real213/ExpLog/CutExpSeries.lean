import E213.Lib.Math.Real213.ExpLog.CutFactorial
...
namespace E213.Lib.Math.Real213.ExpLog.CutExpSeries

open E213.Lib.Math.Real213.ExpLog.CutFactorial (cutInvFactorial)
...
theorem expPartialSum_zero (x : Nat → Nat → Bool) :
    expPartialSum x 0 = E213.Lib.Math.Real213.Sum.CutSumTest.constCut 0 1 := rfl
...
theorem expTerm_zero (x : Nat → Nat → Bool) :
    expTerm x 0
    = cutMul (E213.Lib.Math.Real213.Sum.CutSumTest.constCut 1 1)
             (E213.Lib.Math.Real213.Sum.CutSumTest.constCut 1 1) := rfl
...
theorem cutExp_partial_zero (x : Nat → Nat → Bool) :
    cutExp x 0 = E213.Lib.Math.Real213.Sum.CutSumTest.constCut 0 1 := rfl

end E213.Lib.Math.Real213.ExpLog.CutExpSeries
