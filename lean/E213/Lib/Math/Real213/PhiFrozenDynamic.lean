...
namespace E213.Lib.Math.Real213.PhiFrozenDynamic

open E213.Lib.Math.Real213.PhiCauchyLimit (phiConvergentSeq phiCauchy_limit_eq_phiCut)
open E213.Lib.Math.Real213.FibCassiniNat (fib_cassini_norm convergent_never_frozen)
...
theorem frozen_eq_dynamic_phi (m k n : Nat) :
    ((L 1) ^ 2 - 4 : Int) = 5
    ∧ phiConvergentSeq.limit m k = E213.Lib.Math.Real213.PhiAsCut.phiCut m k
...
end E213.Lib.Math.Real213.PhiFrozenDynamic
