...
import E213.Lib.Math.Real213.Mobius213SternBrocotApps
...
theorem unification_capstone :
    ...
    ∧ (∀ (m k : Nat), 1 ≤ m + k →
        E213.Lib.Math.Real213.Mobius213SternBrocot.SternBrocotReachable (m, k))
...
theorem algebra_preservation_capstone
    {N : Nat} (hN : 0 < N) {vx vx' vy vy' :
      E213.Lib.Math.Real213.NValidCut.ValidCutN N}
    (hx : sternBrocotEq vx.cut vx'.cut)
    (hy : sternBrocotEq vy.cut vy'.cut) :
    sternBrocotEq
      (E213.Lib.Math.Real213.NValidCut.addN N hN vx vy).cut
      (E213.Lib.Math.Real213.NValidCut.addN N hN vx' vy').cut :=
...
end E213.Lib.Math.Real213.Mobius213UnificationCapstone
