...
namespace E213.Lib.Math.Real213.ValidCutFramework
...
theorem validCutSum_int_eq (a b : Nat) :
  ...
  show cutSum (constCut a 1) (constCut b 1) m k
       = constCut (a + b) 1 m k
  exact E213.Lib.Math.Real213.Sum.CutSumOne.cutSum_int_int a b m k
...
end E213.Lib.Math.Real213.ValidCutFramework
