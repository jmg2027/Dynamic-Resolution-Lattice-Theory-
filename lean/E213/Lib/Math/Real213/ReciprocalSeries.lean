...
namespace E213.Lib.Math.Real213.ReciprocalSeries

open E213.Lib.Math.Real213.CrossDetEqDenom (crossdet_eq_denom_total_modulus)
open E213.Lib.Math.Real213.RateModulus (rcut)
open E213.Lib.Math.Cauchy.DepthLiouvilleCoord (fact fact_succ)
...
end E213.Lib.Math.Real213.ReciprocalSeries
