import E213.Lib.Math.Real213.CutLogSeries
import E213.Lib.Math.Real213.CutLogODE
import E213.Lib.Math.Real213.CutLogExpInverse
...
namespace E213.Lib.Math.Real213.CutLogCapstone

open E213.Lib.Math.Real213.CutLogSeries
...
open E213.Lib.Math.Real213.CutLogExpInverse
...
theorem inverse_witness (x : Nat → Nat → Bool) :
    E213.Lib.Math.Real213.CutExpSeries.cutExp x 0 = constCut 0 1
    ∧ cutLog x 0 = constCut 0 1
    ∧ E213.Lib.Math.Real213.CutExpSeries.cutExp (cutLog x 0) 0
        = constCut 0 1
    ∧ cutLog (E213.Lib.Math.Real213.CutExpSeries.cutExp x 0) 0
        = constCut 0 1 :=
...
end E213.Lib.Math.Real213.CutLogCapstone
