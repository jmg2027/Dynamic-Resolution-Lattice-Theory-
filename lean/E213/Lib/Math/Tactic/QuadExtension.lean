...
```
instance : E213.Meta.SelfRecognising.ConjugationCodomain (E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.ZSqrt D) :=
  E213.Lib.Math.Algebra.CayleyDickson.Integer.ZSqrt.conjugation_of_pos (by decide)
```
