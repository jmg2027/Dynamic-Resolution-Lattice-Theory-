...
namespace E213.Lib.Math.Tactic.Extras.HoeffdingFiniteN

open E213.Lib.Math.Probability.Inequality.Hoeffding (hoeffdingBoundAtDepth)
open E213.Lib.Math.NumberSystems.Real213.ExpLog.CutExpSeries
...
end E213.Lib.Math.Tactic.Extras.HoeffdingFiniteN
