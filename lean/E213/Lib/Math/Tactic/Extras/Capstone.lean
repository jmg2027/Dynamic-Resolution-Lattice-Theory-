...
namespace E213.Lib.Math.Tactic.Extras.Capstone

open E213.Lib.Math.Tactic.Extras.CauchySchwarz (two_mul_le_sq_add_sq)
open E213.Lib.Math.Tactic.Extras.LpOneCollapse (lp_one_eq_lebesgue)
open E213.Lib.Math.Tactic.Extras.SymFin
...
end E213.Lib.Math.Tactic.Extras.Capstone
