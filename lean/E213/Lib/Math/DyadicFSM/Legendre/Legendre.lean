...
-- (Pisano.Predictor consumes Legendre, not the other way; cycle
-- broken 2026-05-13 by removing the dead import here.)

/-!
# Legendre — Legendre-symbol Pisano variants (consolidated)

5 variants of the Legendre-symbol-based Pisano period machinery:
core (`Pisano`), extended-precision (`PisanoExt`), small-modulus
direct verification (`Small`), 13/19 specialization (`V13_19`),
and 213-tight package (`V213`).

Per-variant namespaces preserved.
-/
