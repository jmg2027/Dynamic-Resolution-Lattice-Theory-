...
`E213.Lib.Math.DyadicFSM.Product.ProductFSM.BitFSM.product`.  For
...
namespace E213.Lib.Math.DyadicFSM.Pell.LensCompositions
...
open E213.Lib.Math.DyadicFSM.Product.ProductFSMPeriod
  (lens_composition_period)
open E213.Lib.Math.DyadicFSM.Product.ProductFSMPeriodDvd
  (lens_composition_period_dvd)
open E213.Lib.Math.DyadicFSM.ArithFSM.ToBitFSM
...
theorem pellLens_3x5_period_20 :
    ∀ k, (E213.Lib.Math.DyadicFSM.Product.ProductFSM.BitFSM.product
            (n := 9) (m := 25) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 3) pellFSMmod3)
            (ArithFSM2.toBitFSM (by decide : 0 < 5) pellFSMmod5)
            xor).bits (k + 20)
        = (E213.Lib.Math.DyadicFSM.Product.ProductFSM.BitFSM.product
            (n := 9) (m := 25) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 3) pellFSMmod3)
            (ArithFSM2.toBitFSM (by decide : 0 < 5) pellFSMmod5)
            xor).bits k := fun k =>
...
end E213.Lib.Math.DyadicFSM.Pell.LensCompositions
