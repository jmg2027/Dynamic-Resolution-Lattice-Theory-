...
namespace E213.Lib.Math.DyadicFSM.FLT.FLTMain
...
theorem flt_main_5_2 : (2^4) % 5 = 1 % 5 :=
  flt_main 2 4 (by decide)
    E213.Lib.Math.DyadicFSM.FLT.FreshmanDream.middle_vanish_5 modInv_2_mod_5
...
theorem flt_main_7_3 : (3^6) % 7 = 1 % 7 :=
  flt_main 3 6 (by decide)
    E213.Lib.Math.DyadicFSM.FLT.FreshmanDream.middle_vanish_7 modInv_3_mod_7

end E213.Lib.Math.DyadicFSM.FLT.FLTMain
