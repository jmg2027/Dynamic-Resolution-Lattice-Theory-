...
namespace E213.Lib.Math.DyadicFSM.FLT.ChoosePrime

open E213.Lib.Math.DyadicFSM.FLT.Binomial (choose choose_succ_mul)
...
end E213.Lib.Math.DyadicFSM.FLT.ChoosePrime
