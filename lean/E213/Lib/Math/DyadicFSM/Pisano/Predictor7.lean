...
open E213.Lib.Math.DyadicFSM.Pisano.Predictor6 (pisano_predict_correct_6)
...
/-- ★★★★★★★ Predictor computes Pell period at all 7 verified primes. -/
...
end E213.Lib.Math.DyadicFSM.Pisano.Predictor7
