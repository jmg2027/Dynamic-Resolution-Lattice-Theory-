...
| `JsjDeep.lean` | FW-2 | ~41 | JSJ 3-cell complex Euler-target scaffold + cycle inventory (6 multi-edge 2-cycles + 3 simple 4-cycles = 9 atomic, rank 8) + concrete (k, j) attaching map specifications + bipartite S/T cut → JSJ torus parallel + ★★★★★★★ `JSJ_deepening_FW2_close` |
