...
import E213.Lib.Math.Functional.Spectrum
...
namespace E213.Lib.Math.Functional.Capstone

open E213.Lib.Math.Functional.Norm
  (lInfNorm l1Norm constFn lInf_zero l1_zero l1_const lInf_one)
open E213.Lib.Math.Functional.InnerProduct
  (innerNum addFn inner_zero inner_comm inner_left_additive)
open E213.Lib.Math.Functional.LinearOperator
  (LinOp idOp zeroOp scaleOp composeOp id_at zero_at scale_const
   compose_id_left)
open E213.Lib.Math.Functional.Spectrum
...
end E213.Lib.Math.Functional.Capstone
