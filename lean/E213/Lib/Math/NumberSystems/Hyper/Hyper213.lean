...
namespace E213.Lib.Math.NumberSystems.Hyper.Hyper213
...
theorem cofinite_trans (xs ys zs : Hyper213) :
  ...
  have hN1 : n ≥ N1 := Nat.le_trans (E213.Tactic.NatHelper.le_max_left N1 N2) hn
...
end E213.Lib.Math.NumberSystems.Hyper.Hyper213
