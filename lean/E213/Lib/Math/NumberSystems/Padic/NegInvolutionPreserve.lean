import E213.Lib.Math.NumberSystems.Padic.NegInvolutionFull
/-!
...
namespace E213.Lib.Math.NumberSystems.Padic.NegInvolutionPreserve

open E213.Meta.Nat.AddMod213 (double_neg_mod_at)
open E213.Tactic.NatHelper (add_right_cancel_pure div_self_pure)
open E213.Lib.Math.NumberSystems.Padic.NegInvolutionFull
  ...
  | k + 1 => by
    ...
    · -- Prior all-zero: carry = 1, (Zp.neg x).digit_k = (p - x.digit_k) % p
      ...
      | zero =>
        ...
        rw [E213.Lib.Math.NumberSystems.Padic.NegInvolution.zp_neg_digit_zero p hp x]
...
theorem zp_neg_neg_digit_at (p : Nat) (hp : 1 < p) (x : ZpSeq p) :
  ...
  | 0 => E213.Lib.Math.NumberSystems.Padic.NegInvolution.zp_neg_neg_digit_zero p hp x
  | k + 1 => by
...
end E213.Lib.Math.NumberSystems.Padic.NegInvolutionPreserve
