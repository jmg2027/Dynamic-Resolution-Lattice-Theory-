...
namespace E213.Lib.Math.NumberSystems.Real213.Mul.CutMulN
...
private theorem triple_and_pack (a b : Bool) (P : Prop) [Decidable P] :
  ...
  · intro h
    have h1 : (a && b) = true ∧ decide P = true :=
      E213.Lib.Math.NumberSystems.Real213.Sum.BoolOrLadder.and_eq_true_pure _ _ |>.mp h
    have h2 : a = true ∧ b = true :=
      E213.Lib.Math.NumberSystems.Real213.Sum.BoolOrLadder.and_eq_true_pure _ _ |>.mp h1.1
    exact ⟨h2.1, h2.2, of_decide_eq_true h1.2⟩
  · rintro ⟨ha, hb, hP⟩
    exact (E213.Lib.Math.NumberSystems.Real213.Sum.BoolOrLadder.and_eq_true_pure _ _).mpr
      ⟨(E213.Lib.Math.NumberSystems.Real213.Sum.BoolOrLadder.and_eq_true_pure _ _).mpr ⟨ha, hb⟩,
       decide_eq_true hP⟩
...
end E213.Lib.Math.NumberSystems.Real213.Mul.CutMulN
