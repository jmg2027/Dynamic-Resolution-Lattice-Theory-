...
namespace E213.Lib.Math.NumberSystems.Real213.Core.CutFnData
...
def cutScaleLDD (a b : Nat) : LocallyDeterminedData (cutScale a b) where
  ...
  prop := by
    ...
    exact E213.Lib.Math.NumberSystems.Real213.Mul.CutMulOuterReduce.cutMulOuter_reduce_at
...
end E213.Lib.Math.NumberSystems.Real213.Core.CutFnData
