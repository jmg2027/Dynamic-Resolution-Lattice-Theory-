...
namespace E213.Lib.Math.NumberSystems.Real213.Core.MinimumProposition
...
theorem only_one_dyadic_accumulator (a b n : Nat) (c : Nat → Nat → Bool) :
    E213.Lib.Math.NumberSystems.Real213.Core.CutPoset.cutEq
      ...
      ↔ E213.Lib.Math.NumberSystems.Real213.Core.CutPoset.cutEq c (constCut (2^n * a) b) :=
...
end E213.Lib.Math.NumberSystems.Real213.Core.MinimumProposition
