...
/-!
# SignedSum: signed sum + subtraction

cutSignedSum: case analysis on signs.
cutSignedSub: cutSignedSum with negated second arg.
-/

namespace E213.Lib.Math.NumberSystems.Real213.Sum.SignedSum
...
open E213.Lib.Math.NumberSystems.Real213.Sum.CutSumOne (cutSum_half_general cutSum_int_int)
open E213.Lib.Math.NumberSystems.Real213.Sum.Signed (SignedCut cutNeg signedConstCut)
...
def signedCutEq (sx sy : SignedCut) : Prop :=
  sx.sign = sy.sign
    ∧ E213.Lib.Math.NumberSystems.Real213.Core.CutPoset.cutEq sx.cut sy.cut
...
end E213.Lib.Math.NumberSystems.Real213.Sum.SignedSum
