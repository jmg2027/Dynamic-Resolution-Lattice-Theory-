...
import E213.Lib.Math.NumberSystems.Real213.ExpLog.GeomSeriesCauchy
...
namespace E213.Lib.Math.NumberSystems.Real213.ExpLog.CutLogCauchyConvCapstone
...
open E213.Lib.Math.NumberSystems.Real213.ExpLog.GeomSeriesIdentity
  (geom_right_shift geom_depth_zero geom_depth_one geom_depth_two
   geomTermAt_succ geomTermAt_zero)
open E213.Lib.Math.NumberSystems.Real213.ExpLog.GeomSeriesCauchy
  (GeomCauchy trivialGeomCauchy
   trivialGeomCauchy_modulus_zero geom_adjacent_diff)
open E213.Lib.Math.NumberSystems.Real213.ExpLog.GeomCutInvBridge
...
theorem cutInvBridge_witness :
    E213.Lib.Math.NumberSystems.Real213.Mul.CutInv.cutInv (constCut 1 1) 2 1 = true
    ∧ E213.Lib.Math.NumberSystems.Real213.Mul.CutInv.cutInv (constCut 1 1) 1 1 = false
...
end E213.Lib.Math.NumberSystems.Real213.ExpLog.CutLogCauchyConvCapstone
