import E213.Lib.Math.NumberSystems.SignedCut.Octonion.OctonionMulRule
...
namespace E213.Lib.Math.NumberSystems.SignedCut.Octonion.OctonionMulTable

open E213.Lib.Math.NumberSystems.SignedCut.Octonion.OctonionMulRule (Oct octOne quatZero)
...
theorem octOne_neq_octE4 : octOne ≠ octE4 := by
  ...
  have hone2 : quatOne.1.1 = E213.Lib.Math.NumberSystems.Real213.Sum.CutSumTest.constCut 1 1
              := rfl
  have hzero2 : quatZero.1.1 = E213.Lib.Math.NumberSystems.Real213.Sum.CutSumTest.constCut 0 1
              := rfl
  rw [hone2, hzero2] at h2
  have hpt : (E213.Lib.Math.NumberSystems.Real213.Sum.CutSumTest.constCut 1 1
              : Nat → Nat → Bool) 0 1
...
end E213.Lib.Math.NumberSystems.SignedCut.Octonion.OctonionMulTable
