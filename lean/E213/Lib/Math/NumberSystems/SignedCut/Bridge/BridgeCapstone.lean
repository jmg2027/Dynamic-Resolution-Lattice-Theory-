import E213.Lib.Math.NumberSystems.SignedCut.Bridge.Bridge
import E213.Lib.Math.NumberSystems.SignedCut.Core.Inv
...
namespace E213.Lib.Math.NumberSystems.SignedCut.Bridge.BridgeCapstone

open E213.Lib.Math.NumberSystems.SignedCut.Core.Core (SignedCut ofPos ofNeg signedNeg)
open E213.Lib.Math.NumberSystems.SignedCut.Bridge.Bridge
  (fromMagSign fromMagSign_pos fromMagSign_neg
   fromMagSign_neg_distrib)
open E213.Lib.Math.NumberSystems.SignedCut.Core.Inv
...
open E213.Lib.Math.NumberSystems.Real213.Mul.CutInv (cutInv)
...
theorem inv_witness (c : Nat → Nat → Bool) :
    E213.Lib.Math.NumberSystems.SignedCut.Core.Core.pos (signedInvPos c) = cutInv c
    ∧ E213.Lib.Math.NumberSystems.SignedCut.Core.Core.neg (signedInvPos c) = constCut 0 1
    ∧ signedNeg (signedInvPos c) = E213.Lib.Math.NumberSystems.SignedCut.Core.Inv.signedInvNeg c :=
...
theorem unified_witness (x : Nat → Nat → Bool) (N : Nat) :
    E213.Lib.Math.NumberSystems.SignedCut.Core.Core.pos (signedGeomLimitOf x)
        = cutInv (E213.Lib.Math.NumberSystems.SignedCut.Core.Core.pos
                    (E213.Lib.Math.NumberSystems.SignedCut.Bridge.GenericGeomBridge.oneMinus x))
    ∧ E213.Lib.Math.NumberSystems.SignedCut.Core.Core.neg (signedGeomLimitOf x)
        = constCut 0 1
    ∧ E213.Lib.Math.NumberSystems.Real213.ExpLog.CutLogODE.geomPartialSum x 0 = constCut 0 1 :=
...
end E213.Lib.Math.NumberSystems.SignedCut.Bridge.BridgeCapstone
