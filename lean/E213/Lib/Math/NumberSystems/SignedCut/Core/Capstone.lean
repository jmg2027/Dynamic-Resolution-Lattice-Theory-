...
namespace E213.Lib.Math.NumberSystems.SignedCut.Core.Capstone

open E213.Lib.Math.NumberSystems.SignedCut.Core.Core
  (SignedCut zero one negOne pos neg signedNeg signedAdd
   signedSub signedMul)
open E213.Lib.Math.NumberSystems.SignedCut.Core.Algebra
...
end E213.Lib.Math.NumberSystems.SignedCut.Core.Capstone
