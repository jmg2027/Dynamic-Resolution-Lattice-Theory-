...
import E213.Lib.Math.NumberSystems.SignedCut.Bridge.GenericGeomBridge
...
namespace E213.Lib.Math.NumberSystems.SignedCut.Core.UnifiedGenericInv

open E213.Lib.Math.NumberSystems.SignedCut.Core.Core
  (SignedCut zero one ofPos pos neg)
open E213.Lib.Math.NumberSystems.SignedCut.Core.Inv (signedInvPos)
...
theorem unified_fixpoint (x : Nat → Nat → Bool) (N : Nat) :
  ...
  exact E213.Lib.Math.NumberSystems.Real213.ExpLog.GeomSeriesIdentity.geom_right_shift x N

end E213.Lib.Math.NumberSystems.SignedCut.Core.UnifiedGenericInv
