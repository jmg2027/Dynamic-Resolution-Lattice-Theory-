...
open E213.Lib.Math.TriangularTower.OptimalPrecision
...
open E213.Lib.Math.TriangularTower.RealAsSquashed
  (levelsAbove levels_above_eq_23 accumulated_3_axes
   real_line_carries_23_hidden_axes)
open E213.Lib.Math.TriangularTower.AbsorbedByThree
