...
namespace E213.Lib.Math.UniverseChain.RawCountGeneric
...
theorem rawCountG_2 (n : Nat) :
    rawCountG 2 n = E213.Lib.Math.UniverseChain.RawRecurrence.rawCount n := by
  induction n with
  | zero => rfl
  | succ k ih =>
...
end E213.Lib.Math.UniverseChain.RawCountGeneric
