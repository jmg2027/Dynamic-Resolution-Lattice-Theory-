...
`LocalityWitness` requires `f` (global) and `f_at` (pointwise) plus
an `agrees` proof.  For cut algebra, only `f_at` is provided in
PURE form, so we take `f := f_at` with `agrees := fun _ => rfl` —
a trivial self-instance.  The catalog's "duality" collapses for
the cut codomain.
-/

namespace E213.Lib.Math.Foundations.PatternCatalog.Instance

open E213.Lib.Math.Foundations.PatternCatalog
open E213.Lib.Math.Foundations.PatternCatalog.Core
...
/-- *Witness-only* form: drop the redundant `f`. -/
...
open E213.Lens (Lens)
open E213.Lib.Math.Foundations.AxiomSystems.Peano (peanoLens)
open E213.Lib.Math.Foundations.AxiomSystems.CrossTheoryCohabit (r peano_view depth_view)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (InterfaceWitness CatamorphismWitness LensWitness)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (LocalityAggregate)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (Aggregate DynamicalAggregate)
...
Real codebase specimen: `getBase_eq` in
`Lib/Math/Foundations/ArityForcingGeneral.lean` — when the catamorphism `isBase` returns
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (CataForcedForm)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (LocalityForcedValue)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (CataAggregate)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (Forced DynamicalForcedPeriod)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (AggregateForced ForcedAggregate)
...
open E213.Lib.Math.Foundations.PatternCatalog.Core (DepAggregate ArityNCohabit)
...
def threeLensCohabit :
    E213.Lib.Math.Foundations.PatternCatalog.Core.UniformArityNCohabit E213.Theory.Raw Nat :=
  { arity    := 3
...
end E213.Lib.Math.Foundations.PatternCatalog.Instance
