...
namespace E213.Lib.Math.Foundations.UniverseChain.RawDepth3

open E213.Theory
open E213.Lib.Math.Foundations.UniverseChain.RawDepthCount
  (s_ab s_a_ab s_b_ab depthLe2List)
open E213.Lib.Math.Foundations.UniverseChain.RawBipartition (Raw.leftmostAtom)
...
end E213.Lib.Math.Foundations.UniverseChain.RawDepth3
