...
namespace E213.Lib.Math.Analysis.Cauchy.DepthMonotoneSynthesis

open E213.Lib.Math.Analysis.Cauchy.NewtonGregory (newtonZ)
open E213.Lib.Math.Analysis.Cauchy.DepthCharacterization (finite_depthZ_iff polyDepthZ_newtonZ)
open E213.Lib.Math.Analysis.Cauchy.PolyDepthMonotone (MonoFromZ AntiFromZ polyDepthZ_evMono)
...
end E213.Lib.Math.Analysis.Cauchy.DepthMonotoneSynthesis
