...
namespace E213.Lib.Math.Analysis.Cauchy.DepthCubicGeneric

open E213.Meta.Nat.PolyNat (poly_id)
open E213.Lib.Math.Analysis.Cauchy.DepthPRecursiveInstances (binom newton newton_polyDepth)
open E213.Lib.Math.Analysis.Cauchy.DepthPRecursive (polyDepth)
open E213.Lib.Math.Analysis.Cauchy.DepthQuadraticGeneric (binom_one binom_succ_two sq_eq polyDepth_congr)
...
end E213.Lib.Math.Analysis.Cauchy.DepthCubicGeneric
