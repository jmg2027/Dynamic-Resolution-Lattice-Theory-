...
namespace E213.Lib.Math.Analysis.Cauchy.DepthCharacterization

open E213.Lib.Math.Analysis.Cauchy.NewtonGregory
  (diffZ liftKZ isConstZ polyDepthZ bsum newtonZ reconstruct bsum_pascal_aux)
open E213.Lib.Math.Analysis.Cauchy.DepthPRecursiveInstances (binom binom_zero_right)
...
open E213.Lib.Math.Analysis.Cauchy.PolynomialDepth (polyDepthZ_mono)
...
end E213.Lib.Math.Analysis.Cauchy.DepthCharacterization
