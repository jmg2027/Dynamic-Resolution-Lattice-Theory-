...
namespace E213.Lib.Math.Analysis.Cauchy.ThueMorseAperiodic

open E213.Lib.Math.Analysis.Cauchy.MorseHedlund (EvPeriodic aperiodic_not_autoRec b2n)
open E213.Lib.Math.Analysis.Cauchy.ZeroRunNonHolonomic (AutoRec)
open E213.Lib.Math.Analysis.Cauchy.ZeroRunNonHolonomicWitness
...
theorem isPow2_true_iff (n : Nat) : isPow2 n = true ↔ ∃ j, 2 ^ j = n := by
  ...
  · rintro ⟨j, hj⟩
    show E213.Lib.Math.Analysis.Cauchy.ZeroRunNonHolonomicWitness.pow2aux n n = true
...
end E213.Lib.Math.Analysis.Cauchy.ThueMorseAperiodic
