...
namespace E213.Lib.Math.Analysis.Cauchy.CFiniteHadamard
...
open E213.Lib.Math.Algebra.Linalg213.PermClosure (map_map' map_eq_of_mem sumZ_map_smul lt_of_mem_iota)
...
theorem cfiniteZ_mul {s t : Nat → Int} (hs : CFiniteZ s) (ht : CFiniteZ t) :
  ...
  obtain ⟨p, α, hp⟩ := E213.Lib.Math.Analysis.Cauchy.CFiniteRing.shiftRec_of_cfiniteZ hs
  obtain ⟨q, β, hq⟩ := E213.Lib.Math.Analysis.Cauchy.CFiniteRing.shiftRec_of_cfiniteZ ht
  cases p with
  | zero =>
  ...
  | succ p' =>
    ...
    | succ q' =>
      ...
      exact E213.Lib.Math.Analysis.Cauchy.CFiniteRing.neg_eq_of_add_eq_zero key

end E213.Lib.Math.Analysis.Cauchy.CFiniteHadamard
