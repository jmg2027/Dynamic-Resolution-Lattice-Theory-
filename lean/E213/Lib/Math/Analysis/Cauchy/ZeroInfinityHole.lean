...
namespace E213.Lib.Math.Analysis.Cauchy.ZeroInfinityHole

open E213.Lib.Math.Analysis.Cauchy.DetZeroCollapse (cas cas_step cas_conserved_unit)
...
end E213.Lib.Math.Analysis.Cauchy.ZeroInfinityHole
