...
namespace E213.Lib.Math.Analysis.Cauchy.CFiniteRing

open E213.Lib.Math.Analysis.Cauchy.NewtonGregory (diffZ liftKZ mul_zero' add_sub_cancel_left')
open E213.Lib.Math.Analysis.Cauchy.FiniteDepthAlgebra (add_sub_add liftKZ_diffZ_comm)
open E213.Lib.Math.Analysis.Cauchy.OrbitDimension (CFiniteZ linComb)
...
end E213.Lib.Math.Analysis.Cauchy.CFiniteRing
