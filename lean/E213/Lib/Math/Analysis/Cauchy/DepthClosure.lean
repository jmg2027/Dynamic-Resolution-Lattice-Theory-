...
namespace E213.Lib.Math.Analysis.Cauchy.DepthClosure
...
open E213.Lib.Math.Analysis.Cauchy.DepthExponentRecursion
  (expSeq totMono value_floor_of_exponent_floor)
open E213.Lib.Math.Analysis.Cauchy.DepthDoubleExp (twoPow diffN_twoPow dexp_not_const)
...
end E213.Lib.Math.Analysis.Cauchy.DepthClosure
