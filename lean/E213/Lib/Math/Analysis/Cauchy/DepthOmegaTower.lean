...
namespace E213.Lib.Math.Analysis.Cauchy.DepthOmegaTower

open E213.Lib.Math.Analysis.Cauchy.DivergenceLadder (isConst)
open E213.Lib.Math.Analysis.Cauchy.DepthTower (ratioLift geom_ratio_const)
open E213.Lib.Math.Analysis.Cauchy.DepthExponentRecursion (expSeq)
...
end E213.Lib.Math.Analysis.Cauchy.DepthOmegaTower
