...
namespace E213.Lib.Math.Analysis.Cauchy.DepthPiQuartic

open E213.Meta.Nat.PolyNat (poly_id)
open E213.Lib.Math.Analysis.Cauchy.DivergenceLadder (diff liftK)
open E213.Lib.Math.Analysis.Cauchy.DepthPRecursive (polyDepth liftK_diff_comm liftK_congr)
open E213.Lib.Math.Analysis.Cauchy.DepthPRecursiveInstances (wallisDenCoeff)
...
end E213.Lib.Math.Analysis.Cauchy.DepthPiQuartic
