...
namespace E213.Lib.Math.Analysis.Cauchy.ReentryUnit

open E213.Theory (Raw)
open E213.Theory.Raw.Lambek (IsPart part_depth_lt part_depth_succ_le)
open E213.Lib.Math.Analysis.Cauchy.DepthOverflowDuality (Overflow minOverflow overflow_is_unit_surplus)
...
end E213.Lib.Math.Analysis.Cauchy.ReentryUnit
