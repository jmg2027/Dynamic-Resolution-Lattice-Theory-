...
namespace E213.Lib.Math.Analysis.Cauchy.DivergenceDepth

open E213.Lib.Math.Analysis.Cauchy.EulerDivergenceForm (fact eulerDen_eq_fact)
open E213.Lib.Math.Analysis.Cauchy.EulerSeq (eulerDen)
...
end E213.Lib.Math.Analysis.Cauchy.DivergenceDepth
