...
namespace E213.Lib.Math.Analysis.Cauchy.DepthPRecursive

open E213.Lib.Math.Analysis.Cauchy.DivergenceLadder (diff liftK isConst reachesFloor)
...
end E213.Lib.Math.Analysis.Cauchy.DepthPRecursive
