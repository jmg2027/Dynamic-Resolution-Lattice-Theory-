...
namespace E213.Lib.Math.Analysis.Cauchy.WallisDepthProduct

open E213.Lib.Math.Analysis.Cauchy.NewtonGregory (diffZ liftKZ polyDepthZ sub_self_zero)
open E213.Lib.Math.Analysis.Cauchy.FiniteDepthAlgebra (add_sub_add polyDepthZ_mul)
...
end E213.Lib.Math.Analysis.Cauchy.WallisDepthProduct
