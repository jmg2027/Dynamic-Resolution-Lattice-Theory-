...
namespace E213.Lib.Math.Analysis.Cauchy.DepthLiouvilleCoord

open E213.Lib.Math.Analysis.Cauchy.DivergenceLadder (diff)
open E213.Lib.Math.Analysis.Cauchy.DepthTower (ratioLift ratio_is_diff_on_exponent)
...
end E213.Lib.Math.Analysis.Cauchy.DepthLiouvilleCoord
