...
namespace E213.Lib.Math.Analysis.Cauchy.DepthSelfReference

open E213.Lib.Math.Analysis.Cauchy.DivergenceLadder (reachesFloor)
open E213.Lib.Math.Analysis.Cauchy.DepthFloorDetOne (W W_isConst W_eq_one)
...
end E213.Lib.Math.Analysis.Cauchy.DepthSelfReference
