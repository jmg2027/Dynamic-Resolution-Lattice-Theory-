...
namespace E213.Lib.Math.Analysis.Cauchy.CassiniSigned
...
open E213.Lib.Math.Analysis.Cauchy.CasoratianSigned (neg casPair iterNeg neg_congr)
...
end E213.Lib.Math.Analysis.Cauchy.CassiniSigned
