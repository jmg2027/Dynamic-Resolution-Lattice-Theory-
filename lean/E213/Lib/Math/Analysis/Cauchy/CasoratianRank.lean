...
namespace E213.Lib.Math.Analysis.Cauchy.CasoratianRank
...
open E213.Lib.Math.Algebra.Linalg213.RowDependence (det_row_combo_zero)
open E213.Lib.Math.Analysis.Cauchy.CFiniteRing (ShiftRecZ)
open E213.Lib.Math.Analysis.Cauchy.CFiniteHadamard (shiftSum_eq_sumZ)
open E213.Lib.Math.Analysis.Cauchy.OrbitDimension (fibZ)
open E213.Lib.Math.Algebra.Linalg213.DetN (altSign)
open E213.Lib.Math.Algebra.Linalg213.FibCassiniDet (fibCas_det_eq_unit)
...
theorem casoratian_det_zero_of_cfiniteZ {s : Nat → Int}
    (hs : E213.Lib.Math.Analysis.Cauchy.OrbitDimension.CFiniteZ s) :
    ∃ (k : Nat), ∀ (n : Nat), det (k + 1) (fun i j => s (n + i + j)) = 0 := by
  obtain ⟨k, b, hk⟩ := E213.Lib.Math.Analysis.Cauchy.CFiniteRing.shiftRec_of_cfiniteZ hs
...
end E213.Lib.Math.Analysis.Cauchy.CasoratianRank
