...
theorem phiModulus_resolves (m k i j : Nat)
    ...
    E213.Lib.Math.NumberSystems.Real213.Phi.PhiAbCut.phiAb.cut i m k
    = E213.Lib.Math.NumberSystems.Real213.Phi.PhiAbCut.phiAb.cut j m k :=
  E213.Lib.Math.NumberSystems.Real213.Phi.PhiAbCut.phi_cut_eventually_const m k i j hi hj
