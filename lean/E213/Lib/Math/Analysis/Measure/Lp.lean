import E213.Lib.Math.Analysis.Measure.LebesgueIntegral
...
namespace E213.Lib.Math.Analysis.Measure.Lp
...
open E213.Lib.Math.Analysis.Measure.LebesgueIntegral
...
theorem lp_union_additive (p : Nat) (f : Nat → Nat)
    ...
    lpNormPow p f (E213.Lib.Math.Analysis.Measure.MeasurableSet.union s t)
      = lpNormPow p f s + lpNormPow p f t :=
  E213.Lib.Math.Analysis.Measure.LebesgueIntegral.lebesgue_union_additive
...
end E213.Lib.Math.Analysis.Measure.Lp
