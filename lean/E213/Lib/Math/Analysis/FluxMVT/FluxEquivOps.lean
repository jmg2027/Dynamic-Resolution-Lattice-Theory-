...
open E213.Lib.Math.NumberSystems.Real213.Core.CutPoset (cutEq_refl)
open E213.Lib.Math.Analysis.FluxMVT.FluxEquiv.FluxCut (cohomEquiv)
open E213.Lib.Math.NumberSystems.Real213.Sum.CutSumEq (cutSum_cutEq_both cutMul_cutEq_both)
