...
Sub-namespaces preserved (cross-file `open` declarations stay valid):
  ...
  * `E213.Lib.Math.Analysis.FluxMVT.FluxMVTPassthrough`   — the general theorem
...
namespace E213.Lib.Math.Analysis.FluxMVT.FluxMVTPassthrough
...
theorem ftc_bridge_passthrough_unit_pure
  ...
  E213.Lib.Math.Analysis.FluxMVT.FluxMVT.FluxCut.fluxBalance_trans
    (mvt_passthrough_unit_pure f h_left h_right)
    (E213.Lib.Math.Analysis.FluxMVT.FluxMVT.FluxCut.fluxBalance_symm _ _
      (fluxAlong_passthrough_unit_pure f h_left h_right))

end FluxCut

end E213.Lib.Math.Analysis.FluxMVT.FluxMVTPassthrough

namespace E213.Lib.Math.Analysis.FluxMVTClosure
...
open E213.Lib.Math.Analysis.FluxMVT.FluxMVTPassthrough.FluxCut
...
end E213.Lib.Math.Analysis.FluxMVTClosure

namespace E213.Lib.Math.Analysis.FluxMVTApplications
...
open E213.Lib.Math.Analysis.FluxMVT.FluxMVT.FluxCut (fluxCutEq)
open E213.Lib.Math.Analysis.FluxMVT.FluxMVTPassthrough.FluxCut (mvt_passthrough_unit_pure)
open E213.Lib.Math.Real213.CutMulOne (cutMul_one_one_at cutMul_one_const_at)
open E213.Lib.Math.Real213.CutSumZero (cutMul_zero_zero_at)
open E213.Lib.Math.Real213.CutPowConst (cutPow_one_n_at cutPow_zero_succ_at)
...
theorem mvt_cube_via_passthrough_pure :
  ...
  mvt_passthrough_unit_pure (fun x => cutMul x (cutMul x x))
    (E213.Lib.Math.Analysis.FluxMVT.FluxMVTPolynomial.FluxCut.fluxAlong_cube_unitBracket_backward_at)
    (E213.Lib.Math.Analysis.FluxMVT.FluxMVTPolynomial.FluxCut.fluxAlong_cube_unitBracket_forward_at)

end FluxCut

end E213.Lib.Math.Analysis.FluxMVTApplications
