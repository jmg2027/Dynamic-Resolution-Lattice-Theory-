...
open E213.Lib.Math.Real213.CutMulOne (cutMul_one_const_at cutMul_const_one_at)
open E213.Lib.Math.Real213.CutSumZero (cutMul_zero_zero_at cutSum_zero_zero_at)
    ...
    cutSumAux_congr k (2*m)
      ...
      (fun m' _ => by
        show cutMul (constCut 1 1) (cutMul (constCut 0 1) (constCut 0 1)) m' (2*k)
              = constCut 0 1 m' (2*k)
        show E213.Lib.Math.Real213.CutMul.cutMulOuter (constCut 1 1)
              (cutMul (constCut 0 1) (constCut 0 1))
              (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1))
            = constCut 0 1 m' (2*k)
        have step :
            E213.Lib.Math.Real213.CutMul.cutMulOuter (constCut 1 1)
              (cutMul (constCut 0 1) (constCut 0 1))
              (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1))
            = E213.Lib.Math.Real213.CutMul.cutMulOuter (constCut 1 1) (constCut 0 1)
              (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1)) :=
          E213.Lib.Math.Real213.CutMulDetermined.cutMulOuter_congr
            (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1))
      ...
      (fun m' _ => by
        show cutMul (constCut 0 1)
            ...
            = constCut 0 1 m' (2*k)
        show E213.Lib.Math.Real213.CutMul.cutMulOuter (constCut 0 1)
              (cutSum (cutMul (constCut 1 1) (constCut 0 1))
                      (cutMul (constCut 0 1) (constCut 1 1)))
              (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1))
            = constCut 0 1 m' (2*k)
        have step :
            E213.Lib.Math.Real213.CutMul.cutMulOuter (constCut 0 1)
              (cutSum (cutMul (constCut 1 1) (constCut 0 1))
                      (cutMul (constCut 0 1) (constCut 1 1)))
              (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1))
            = E213.Lib.Math.Real213.CutMul.cutMulOuter (constCut 0 1) (constCut 0 1)
              (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1)) :=
          E213.Lib.Math.Real213.CutMulDetermined.cutMulOuter_congr
            (2*k) m' ((m'+1)*((2*k)+1)) ((m'+1)*((2*k)+1))
...
end E213.Lib.Math.Analysis.Differentiation.CubeDerivativeAtZero
