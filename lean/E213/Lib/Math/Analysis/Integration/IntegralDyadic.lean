...
namespace E213.Lib.Math.Analysis.Integration.IntegralDyadic
...
theorem fluxAlong_id_dyadicAB (numA numB E : Nat) (h : numA ≤ numB) :
    E213.Lib.Math.Analysis.FluxMVT.FluxCochain.FluxCut.fluxAlong id (dyadicIntervalAB numA numB E h)
...
end E213.Lib.Math.Analysis.Integration.IntegralDyadic
