...
## Three axes (sub-namespaces preserved)
  ...
  * `E213.Lib.Math.Analysis.Integration.Antiderivative`            — definition + atomic instances
...
namespace E213.Lib.Math.Analysis.Integration.Antiderivative
...
end E213.Lib.Math.Analysis.Integration.Antiderivative

namespace E213.Lib.Math.Analysis.AntiderivativeCombinators
...
end E213.Lib.Math.Analysis.AntiderivativeCombinators

namespace E213.Lib.Math.Analysis.AntiderivativeStructural
...
end E213.Lib.Math.Analysis.AntiderivativeStructural
