...
namespace E213.Lib.Math.Analysis.Integration.IntegralProperties
...
open E213.Lib.Math.Analysis.Integration.Antiderivative
  (IsAntiderivative)
open E213.Lib.Math.Analysis.Integration.Antiderivative.IsAntiderivative
  (id_anti)
open E213.Lib.Math.Analysis.AntiderivativeCombinators.IsAntiderivative
  (add_anti mid_anti)
    ...
    integral (add_anti id_anti id_anti) db
      = ({ forward := cutSum (db.rightCut) (db.rightCut),
           backward := cutSum (db.leftCut) (db.leftCut) }
              : E213.Lib.Math.Analysis.FluxMVT.FluxCut.FluxCut)
...
end E213.Lib.Math.Analysis.Integration.IntegralProperties
