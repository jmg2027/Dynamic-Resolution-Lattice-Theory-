...
import E213.Lib.Math.Analysis.Multivariable.PartialDerivative
import E213.Lib.Math.Analysis.Multivariable.Gradient
import E213.Lib.Math.Analysis.Multivariable.MultiIntegral
import E213.Lib.Math.Analysis.Multivariable.Stokes
...
namespace E213.Lib.Math.Analysis.Multivariable.Capstone

open E213.Lib.Math.Analysis.Multivariable.MultiCut (MultiCut zero one update)
open E213.Lib.Math.Analysis.Multivariable.PartialDerivative (partialAt proj)
open E213.Lib.Math.Analysis.Multivariable.Gradient (gradient)
open E213.Lib.Math.Analysis.Multivariable.MultiIntegral (multiVolumeNum multiCubeUnit)
open E213.Lib.Math.Analysis.Multivariable.Stokes (stokes1D ddOmega_zero_skeleton)

/-- ★ **MultiCut witness** ★ — update / zero / one structural. -/
theorem multiCut_witness (i : Fin 5) (c : Nat → Nat → Bool) :
    update (zero 5) i c i = c
    ∧ zero 5 i = E213.Lib.Math.NumberSystems.Real213.Sum.CutSumTest.constCut 0 1
    ∧ one 5 i = E213.Lib.Math.NumberSystems.Real213.Sum.CutSumTest.constCut 1 1 :=
  ⟨E213.Lib.Math.Analysis.Multivariable.MultiCut.update_self _ i c, rfl, rfl⟩
...
theorem partial_witness (i : Fin 5) (x : MultiCut 5)
  ...
  E213.Lib.Math.Analysis.Multivariable.PartialDerivative.partialAt_proj_self i x y
...
theorem total_witness (i : Fin 5) (x : MultiCut 5)
    ...
    ∧ multiVolumeNum 2 = 1
    ∧ (n - n : Nat) = 0 :=
  ⟨E213.Lib.Math.Analysis.Multivariable.MultiCut.update_self x i c,
   E213.Lib.Math.Analysis.Multivariable.PartialDerivative.partialAt_proj_self i x y,
   rfl, by decide, Nat.sub_self n⟩

end E213.Lib.Math.Analysis.Multivariable.Capstone
