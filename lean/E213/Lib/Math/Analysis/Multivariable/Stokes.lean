...
namespace E213.Lib.Math.Analysis.Multivariable.Stokes

open E213.Lib.Math.Analysis.Multivariable.MultiCut (MultiCut)
open E213.Lib.Math.Analysis.Multivariable.MultiIntegral (multiCubeUnit multiVolumeNum)
...
end E213.Lib.Math.Analysis.Multivariable.Stokes

namespace E213.Lib.Math.Analysis.Multivariable.Stokes2D

open E213.Lib.Math.Analysis.Multivariable.MultiIntegral
...
end E213.Lib.Math.Analysis.Multivariable.Stokes2D

namespace E213.Lib.Math.Analysis.Multivariable.Stokes3D
...
theorem divergence_master (c : Nat) :
    ...
    ∧ E213.Lib.Math.Analysis.Multivariable.MultiIntegral.multiVolumeNum 3 = 1
    ∧ E213.Lib.Math.Analysis.Multivariable.MultiIntegral.multiVolumeNum 4 = 1 := by
  refine ⟨?_, ?_, ?_, rfl, rfl⟩
...
end E213.Lib.Math.Analysis.Multivariable.Stokes3D

namespace E213.Lib.Math.Analysis.Multivariable.Stokes4D
...
theorem stokes_4d_master (c : Nat) :
    ...
    ∧ E213.Lib.Math.Analysis.Multivariable.MultiIntegral.multiVolumeNum 4 = 1
    ∧ E213.Lib.Math.Analysis.Multivariable.MultiIntegral.multiVolumeNum 5
        = 1 * E213.Lib.Math.Analysis.Multivariable.MultiIntegral.multiVolumeNum 5 := by
  refine ⟨?_, ?_, ?_, rfl, ?_⟩
...
end E213.Lib.Math.Analysis.Multivariable.Stokes4D
