...
namespace E213.Lib.Math.Analysis.Multivariable.PartialDerivative

open E213.Lib.Math.Analysis.Multivariable.MultiCut (MultiCut update)
...
theorem partialAt_proj_self {n : Nat} (i : Fin n) (x : MultiCut n)
  ...
  exact E213.Lib.Math.Analysis.Multivariable.MultiCut.update_self x i y

end E213.Lib.Math.Analysis.Multivariable.PartialDerivative
