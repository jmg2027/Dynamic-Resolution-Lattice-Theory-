...
| `HeatEq/Discrete.lean` | 1D periodic heat eq; maximum principle (per-step/iterated/strong-strict), comparison principle, lazy `(¼,½,¼)` stencil + checkerboard spectral-gap witness | ∅-axiom |
