...
namespace E213.Lib.Math.Analysis.Functional.LinearOperator

open E213.Lib.Math.Analysis.Functional.Norm (constFn)
...
end E213.Lib.Math.Analysis.Functional.LinearOperator
