...
namespace E213.Lib.Math.Cauchy.QuasiPolyBound

open E213.Lib.Math.Cauchy.NewtonGregory (liftKZ diffZ polyDepthZ poly_bound)
open E213.Lib.Math.Cauchy.DepthPRecursive (polyDepth)
open E213.Lib.Math.Cauchy.HurwitzianCF
...
end E213.Lib.Math.Cauchy.QuasiPolyBound
