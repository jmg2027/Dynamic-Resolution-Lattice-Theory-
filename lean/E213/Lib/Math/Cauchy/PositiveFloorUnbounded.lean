...
open E213.Lib.Math.Cauchy.DepthPRecursive
  (polyDepth polyDepth_succ_iff const_polyDepth0)
open E213.Lib.Math.Cauchy.HurwitzianCF (ePQ polyDepth_congr resP_mod res3_div)
...
end E213.Lib.Math.Cauchy.PositiveFloorUnbounded
