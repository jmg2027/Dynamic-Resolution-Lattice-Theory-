...
import E213.Lib.Math.HodgeConjecture.Toolkit.Primitives
...
import E213.Lib.Math.HodgeConjecture.MotivicBridge.Tate
...
import E213.Lib.Math.HodgeConjecture.MotivicBridge.MumfordTate
import E213.Lib.Math.HodgeConjecture.MotivicBridge.BlochBeilinson
import E213.Lib.Math.HodgeConjecture.Bridge.BeilinsonRegulator
import E213.Lib.Math.HodgeConjecture.Refinement.Voisin
import E213.Lib.Math.HodgeConjecture.MotivicBridge.ChernCharacter
import E213.Lib.Math.HodgeConjecture.MotivicBridge.HodgeTate
import E213.Lib.Math.HodgeConjecture.MotivicBridge.BeilinsonLichtenbaum

/-!
# HodgeConjecture API — single import for the whole HC²¹³ + post-HC cluster

`import E213.Lib.Math.HodgeConjecture.API` exposes all 29
...
namespace E213.Lib.Math.HodgeConjecture.API

/-- ★★★★★★★★★★ Master citation alias.

    The single citable theorem closing the Hodge conjecture in 213.
    Equivalent to
    `E213.Lib.Math.HodgeConjecture.Foundation.Complete.hodge_conjecture_213_complete`.

    Type: `HC_Universal ∧ HC_K32 ∧ HC_Involution`. -/
@[reducible] def HC213 :=
  @E213.Lib.Math.HodgeConjecture.Foundation.Complete.hodge_conjecture_213_complete

end E213.Lib.Math.HodgeConjecture.API
