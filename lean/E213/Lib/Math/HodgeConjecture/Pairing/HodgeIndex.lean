...
namespace E213.Lib.Math.HodgeConjecture.Pairing.HodgeIndex

open E213.Lib.Math.Cohomology.Bipartite.V32Betti
open E213.Lib.Math.HodgeConjecture.Toolkit.LensClassifier (edgeBasis)
...
end E213.Lib.Math.HodgeConjecture.Pairing.HodgeIndex
