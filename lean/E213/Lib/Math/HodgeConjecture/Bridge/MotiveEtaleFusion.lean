...
namespace E213.Lib.Math.HodgeConjecture.Bridge.MotiveEtaleFusion

open E213.Lib.Physics.Simplex.Counts (binom NS NT)
open E213.Lib.Math.HodgeConjecture.Bridge.BeilinsonRegulator
  (zetaΔ zetaK regulatorΔ regulatorK)
open E213.Lib.Math.HodgeConjecture.Bridge.GaloisCounterfactual
...
end E213.Lib.Math.HodgeConjecture.Bridge.MotiveEtaleFusion
