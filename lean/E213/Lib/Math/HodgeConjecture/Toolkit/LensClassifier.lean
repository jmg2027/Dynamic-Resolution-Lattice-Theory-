...
namespace E213.Lib.Math.HodgeConjecture.Toolkit.LensClassifier

open E213.Lib.Math.Cohomology.Bipartite.V32 (CochE)
open E213.Lib.Math.HodgeConjecture.Foundation.ConjectureLens (edgeIndicator IsEdgeAlgebraic)
...
end E213.Lib.Math.HodgeConjecture.Toolkit.LensClassifier
