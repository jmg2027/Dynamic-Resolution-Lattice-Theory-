...
/-!
# Information 213 — umbrella

213-native information theory: bit = bisection, log₂(2^n) = n
atomic, Shannon entropy = depth.  Built on Probability 213.
See `Information/INDEX.md` for the file map.
-/
