...
namespace E213.Lib.Math.SignedCut.Hurwitz.HurwitzFailure

open E213.Lib.Math.SignedCut.Octonion.OctonionMulRule (Oct octOne quatZero)
open E213.Lib.Math.SignedCut.Octonion.QuaternionMulRule (Quat quatOne)
...
end E213.Lib.Math.SignedCut.Hurwitz.HurwitzFailure
