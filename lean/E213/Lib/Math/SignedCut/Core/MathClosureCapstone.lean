import E213.Lib.Math.SignedCut.Hurwitz.HurwitzExactL1
import E213.Lib.Math.SignedCut.Octonion.QuaternionMulTable
import E213.Lib.Math.SignedCut.Octonion.OctonionMulTable
...
open E213.Lib.Math.SignedCut.Octonion.QuaternionMulTable
  (quatI_neq_quatJ quatI_neq_quatK quatOne_neq_quatI)
open E213.Lib.Math.SignedCut.Octonion.OctonionMulTable
  (octE1_neq_octE2 octOne_neq_octE4)
open E213.Lib.Math.SignedCut.Octonion.QuaternionMulRule
  (quatOne quatI quatJ quatK)
open E213.Lib.Math.SignedCut.Octonion.OctonionMulRule (octOne)
...
theorem oct_basis_distinct :
    E213.Lib.Math.SignedCut.Octonion.OctonionMulTable.octE1
      ≠ E213.Lib.Math.SignedCut.Octonion.OctonionMulTable.octE2
    ∧ octOne
      ≠ E213.Lib.Math.SignedCut.Octonion.OctonionMulTable.octE4 :=
  ⟨octE1_neq_octE2, octOne_neq_octE4⟩
