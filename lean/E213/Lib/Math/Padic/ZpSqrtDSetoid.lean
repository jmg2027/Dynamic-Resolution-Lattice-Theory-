import E213.Lib.Math.Padic.SetoidAlgebra
...
namespace E213.Lib.Math.Padic.ZpSqrtDSetoid

open E213.Lib.Math.Padic.HenselBridge (fromFp)
open E213.Lib.Math.Padic.ZpSqrtD
  (ZpSqrtD zpsd_add zpsd_mul zpsd_zero zpsd_one fp2d_to_zpsd)
open E213.Lib.Math.Padic.ZpSqrtDFrob (zpsd_frob)
open E213.Lib.Math.Padic.SetoidFramework
  (ZpSeqEquiv ZpSeqEquiv.refl ZpSeqEquiv.symm ZpSeqEquiv.trans)
open E213.Lib.Math.Padic.SetoidAlgebra
...
end E213.Lib.Math.Padic.ZpSqrtDSetoid
