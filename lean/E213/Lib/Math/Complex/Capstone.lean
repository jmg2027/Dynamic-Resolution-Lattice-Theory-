...
import E213.Lib.Math.Complex.Holomorphic
import E213.Lib.Math.Complex.PowerSeries
...
namespace E213.Lib.Math.Complex.Capstone

open E213.Lib.Math.Complex.ComplexCut (ComplexCut zero one i re im)
open E213.Lib.Math.Complex.Holomorphic (idHolomorphic constHolomorphic)
open E213.Lib.Math.Complex.PowerSeries (polyId polyConst cExpAtZero)
