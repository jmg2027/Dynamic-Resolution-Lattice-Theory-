import E213.Lib.Math.LevelTopology.MagnitudeTopology
import E213.Lib.Math.LevelTopology.SignTopology
import E213.Lib.Math.LevelTopology.ComplexTopology
import E213.Lib.Math.LevelTopology.QuaternionTopology
import E213.Lib.Math.LevelTopology.TwoTowersDivergence
...
open E213.Lib.Math.LevelTopology.ComplexTopology (cycle_structure)
open E213.Lib.Math.LevelTopology.QuaternionTopology (K3_structure)
open E213.Lib.Math.LevelTopology.TwoTowersDivergence
...
theorem divergence_witness :
    E213.Lib.Math.LevelTopology.TwoTowersDivergence.total213Floors
      = E213.Lib.Math.LevelTopology.TwoTowersDivergence.totalClassicalCDFloors + 1 :=
  divergence

/-- ★★★ Total: all 4 floors + divergence. -/
theorem total_witness :
    E213.Lib.Math.LevelTopology.MagnitudeTopology.nodeCount = 1
    ∧ E213.Lib.Math.LevelTopology.SignTopology.nodeCount = 2
    ∧ E213.Lib.Math.LevelTopology.ComplexTopology.nodeCount = 4
