...
namespace E213.Lib.Math.Extras.AggregatorCapstone

open E213.Lib.Math.Extras.CauchySchwarz2D (cs_2d_le cross_term_le)
open E213.Lib.Math.Extras.HoeffdingFiniteN
...
theorem hoeffding_finiteN_witness (negArg : Nat → Nat → Bool) :
    E213.Lib.Math.Probability.Hoeffding.hoeffdingBoundAtDepth negArg 1
      = E213.Lib.Math.Real213.CutExpSeries.expPartialSum negArg 1
    ∧ E213.Lib.Math.Probability.Hoeffding.hoeffdingBoundAtDepth negArg 2
        = E213.Lib.Math.Real213.CutExpSeries.expPartialSum negArg 2 :=
...
end E213.Lib.Math.Extras.AggregatorCapstone
