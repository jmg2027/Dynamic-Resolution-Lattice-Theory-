...
theorem Hurwitz_units_count :
    E213.Lib.Math.CayleyDickson.Integer.Hurwitz213.hur_units.length = 24 :=
  E213.Lib.Math.CayleyDickson.Integer.Hurwitz213.hur_units_count
...
end E213.Lib.Math.CayleyDickson.Misc.TypeE_Rejection
