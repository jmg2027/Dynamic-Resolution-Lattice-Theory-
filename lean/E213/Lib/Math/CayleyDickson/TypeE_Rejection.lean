...
namespace E213.Lib.Math.CayleyDickson.TypeE_Rejection
...
theorem Hurwitz_units_count :
    E213.Lib.Math.CayleyDickson.Hurwitz213.hur_units.length = 24 :=
  E213.Lib.Math.CayleyDickson.Hurwitz213.hur_units_count
...
end E213.Lib.Math.CayleyDickson.TypeE_Rejection
