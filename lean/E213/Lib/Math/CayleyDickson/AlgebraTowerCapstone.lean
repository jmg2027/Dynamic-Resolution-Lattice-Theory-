import E213.Lib.Math.CayleyDickson.AlgebraTowerAsymptote
import E213.Lib.Math.CayleyDickson.Order4Monopoly_L4T
import E213.Lib.Math.CayleyDickson.Order4Monopoly_L5T
import E213.Lib.Math.CayleyDickson.Order4Monopoly_L6T
...
import E213.Lib.Math.CayleyDickson.UniversalInduction
...
namespace E213.Lib.Math.CayleyDickson.AlgebraTowerCapstone

/-- Sentinel: this capstone imports all algebra-tower discovery files. -/
theorem capstone_loaded : True := trivial

end E213.Lib.Math.CayleyDickson.AlgebraTowerCapstone
