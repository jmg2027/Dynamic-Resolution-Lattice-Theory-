...
def Sedenion.I' : Sedenion := ⟨E213.Lib.Math.CayleyDickson.Levels.Cayley.Cayley.Cayley.I', 0⟩
def Sedenion.J' : Sedenion := ⟨E213.Lib.Math.CayleyDickson.Levels.Cayley.Cayley.Cayley.J', 0⟩
def Sedenion.L' : Sedenion := ⟨E213.Lib.Math.CayleyDickson.Levels.Cayley.Cayley.L, 0⟩
