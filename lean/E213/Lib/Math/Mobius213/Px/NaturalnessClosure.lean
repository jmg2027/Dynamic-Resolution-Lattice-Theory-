...
namespace E213.Lib.Math.Mobius213.Px.NaturalnessClosure
...
/-- However, the modulus `7` itself is not atomic-derivable.
    ...
    `lean/E213/Lib/Math/ModArith/` provides only `PureNatMod3`,
...
/-- ★★★★★★★★★ **Naturalness closure master**: 213-internal
    ...
    iff:
      ...
      (c) modular reductions, if any, use only atomic-prime
          ...
          `Lib/Math/ModArith/PureNatMod{3, 5}`).
...
end E213.Lib.Math.Mobius213.Px.NaturalnessClosure
