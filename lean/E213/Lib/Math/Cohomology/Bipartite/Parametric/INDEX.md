...
**Status**: 8 files at root + `Betti/` subcluster (5 files); ~221 PURE.  Direction A **CLOSED** at three
...
| `Betti/` | 46 | **Universal b₀ / b₁ subcluster** (5 files) — kernel = constants + image count + `b₁ = E−V+1 = 1/α₃`; see `Betti/INDEX.md` |
...
| `PellOrbitInstances.lean` | — | 12 | **Pell-orbit Stern-Brocot extension**: Direction A transported to the next mediant layer — K_{7,4}, K_{8,5}, K_{5,4}, K_{13,8} all closed |
