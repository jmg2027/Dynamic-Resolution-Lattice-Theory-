...
namespace E213.Lib.Math.Cohomology.Examples.DiamondShape
...
/-- Signature factor = NT = 2 (order-2/period-2 sign, not a multiplicity). -/
theorem lattice_cycle : NT = 2 := by decide

/-- Total edges = NT·NS·NT = 12. -/
theorem total_edges :
...
end E213.Lib.Math.Cohomology.Examples.DiamondShape
