...
namespace E213.Lib.Math.Cohomology.Capstone
...
open E213.Lib.Math.Cohomology.Cup.Ring (unit_5 cup_unit_left_v0)
open E213.Lib.Math.Cohomology.Cup.Leibniz (leibniz_v0_v0_pointwise)
