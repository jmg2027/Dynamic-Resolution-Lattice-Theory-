...
* `b_1(K_{3,2}^{(2)}) = 8` is now derived two ways:
  - **Scalar**: `Physics.PhotonKernel.b_1_eq_8` (Euler formula
    E − V + 1 = 12 − 5 + 1 = 8).
  - **Chain-level**: `E213.Lib.Math.Cohomology.Bipartite.V32Betti.b1_eq_8_dim_count` (rank-nullity from
...
theorem b1_two_derivations_agree :
    b_1 = E213.Lib.Math.Cohomology.Bipartite.V32Betti.kerSizeDelta0 * 4
    ∧ b_1 = NS * NS - 1
