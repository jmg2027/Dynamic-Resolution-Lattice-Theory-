...
namespace E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.PhaseRouting

open E213.Lib.Physics.Simplex.Counts (binom NS NT)
open E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.BeilinsonRegulator (zetaΔ)
open E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.GaloisCounterfactual (fixedCount)
open E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.MotiveEtaleFusion
  (motivicDim etaleDim)
...
end E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.PhaseRouting
