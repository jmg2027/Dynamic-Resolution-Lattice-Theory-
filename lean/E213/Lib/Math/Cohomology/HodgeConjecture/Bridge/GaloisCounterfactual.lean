...
namespace E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.GaloisCounterfactual

open E213.Lib.Physics.Simplex.Counts (binom NS NT)
open E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.BeilinsonRegulator (zetaΔ zetaK)
...
end E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.GaloisCounterfactual
