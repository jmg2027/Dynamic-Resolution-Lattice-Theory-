...
namespace E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.SpinGlass

open E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.Ising (Spin mkSpin allDown allUp)
...
end E213.Lib.Math.Cohomology.HodgeConjecture.Bridge.SpinGlass
