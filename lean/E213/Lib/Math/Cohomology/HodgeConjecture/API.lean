...
import E213.Lib.Math.Cohomology.HodgeConjecture.Refinement.GeneralizedHodge
import E213.Lib.Math.Cohomology.HodgeConjecture.Refinement.StandardConjectures
import E213.Lib.Math.Cohomology.HodgeConjecture.Structure.HardLefschetz
...
import E213.Lib.Math.Cohomology.HodgeConjecture.Refinement.LefschetzHyperplane
...
`import E213.Lib.Math.Cohomology.HodgeConjecture.API` exposes all 29
...
/-- ★★★★★★★★★★ Master citation alias.
    ...
    Equivalent to
    `E213.Lib.Math.Cohomology.HodgeConjecture.Foundation.Complete.hodge_conjecture_213_complete`.

    Type: `HC_Universal ∧ HC_K32 ∧ HC_Involution`. -/
@[reducible] def HC213 :=
  @E213.Lib.Math.Cohomology.HodgeConjecture.Foundation.Complete.hodge_conjecture_213_complete

end E213.Lib.Math.Cohomology.HodgeConjecture.API
