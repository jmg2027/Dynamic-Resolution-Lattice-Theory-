...
import E213.Lib.Math.Cohomology.HodgeConjecture.Structure.HardLefschetzT2Squared
...
/-! Spec-as-code entry point for `E213.Lib.Math.Cohomology.HodgeConjecture.Structure`.
