...
namespace E213.Lib.Math.Cohomology.HodgeConjecture.Toolkit.LensClassifier

open E213.Lib.Math.Cohomology.Bipartite.V32 (CochE)
open E213.Lib.Math.Cohomology.HodgeConjecture.Foundation.ConjectureLens (edgeIndicator IsEdgeAlgebraic)
...
end E213.Lib.Math.Cohomology.HodgeConjecture.Toolkit.LensClassifier
