...
두 종류 Nat213 표현:
  - Raw chain (canonical):  `Lens.Number.Nat213.Raw` — Method A Raw chain.
                             `one := Raw.a`, `succ n := slashOrSelf n Raw.b`
  - Inductive Peano:        `Lens.Number.Nat213.Peano.Nat213` — `inductive | one | succ`

이 모듈은 둘 사이 bridge.  결론: 두 표현이 산술 (succ/add/mul) 위에서
**isomorphic** — 산술 연산들이 bridge 를 따라 commute.

이게 framework 의 정합성: closed-Raw 가 inductive Peano Nat213 의 진짜 모델.
-/
...
/-- 기본 케이스. -/
theorem toRaw_one :
    toRaw E213.Lens.Number.Nat213.Peano.Nat213.one = E213.Lens.Number.Nat213.Raw.one := rfl
...
theorem toRaw_ne_b (k : E213.Lens.Number.Nat213.Peano.Nat213) : toRaw k ≠ Raw.b := by
  induction k with
  | one =>
...
theorem toRaw_add (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    toRaw (E213.Lens.Number.Nat213.Peano.Nat213.add m n)
      = E213.Lens.Number.Nat213.Raw.add (toRaw m) (toRaw n) := by
  induction m with
  | one =>
      -- Layer 2: add one n = succ n.  Layer 1: add one (toRaw n) = succ (toRaw n).
      show toRaw (E213.Lens.Number.Nat213.Peano.Nat213.succ n)
         = E213.Lens.Number.Nat213.Raw.add E213.Lens.Number.Nat213.Raw.one (toRaw n)
      rw [E213.Lens.Number.Nat213.Raw.one_add]
      rfl
  | succ k ih =>
      ...
      show toRaw (E213.Lens.Number.Nat213.Peano.Nat213.succ (E213.Lens.Number.Nat213.Peano.Nat213.add k n))
         = E213.Lens.Number.Nat213.Raw.add
              (E213.Lens.Number.Nat213.Raw.succ (toRaw k)) (toRaw n)
      rw [toRaw_succ, E213.Lens.Number.Nat213.Raw.add_succ_left _ _ (toRaw_ne_b k), ih]
...
theorem toRaw_mul (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    toRaw (E213.Lens.Number.Nat213.Peano.Nat213.mul m n)
      = E213.Lens.Number.Nat213.Raw.mul (toRaw m) (toRaw n) := by
  induction m with
  | one =>
      -- Layer 2: mul one n = n.  Layer 1: mul one (toRaw n) = toRaw n.
      show toRaw n = E213.Lens.Number.Nat213.Raw.mul E213.Lens.Number.Nat213.Raw.one (toRaw n)
      rw [E213.Lens.Number.Nat213.Raw.one_mul]
  | succ k ih =>
      -- Layer 2: mul (succ k) n = add n (mul k n).
      -- Layer 1: mul (succ (toRaw k)) (toRaw n)
      --       = add (toRaw n) (mul (toRaw k) (toRaw n))   (mul_succ_left)
      show toRaw (E213.Lens.Number.Nat213.Peano.Nat213.add n (E213.Lens.Number.Nat213.Peano.Nat213.mul k n))
         = E213.Lens.Number.Nat213.Raw.mul
              (E213.Lens.Number.Nat213.Raw.succ (toRaw k)) (toRaw n)
      rw [E213.Lens.Number.Nat213.Raw.mul_succ_left _ _ (toRaw_ne_b k)]
      rw [toRaw_add, ih]
...
theorem add_comm (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.add (toRaw m) (toRaw n)
      = E213.Lens.Number.Nat213.Raw.add (toRaw n) (toRaw m) := by
  rw [← toRaw_add, ← toRaw_add, E213.Lens.Number.Nat213.Peano.Nat213.add_comm]

/-- `add_one_right`: `add m one = succ m` for chains from Layer 2.
    Layer 2 의 `add_one_right` 직접 활용. -/
theorem add_one_right (m : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.add (toRaw m) E213.Lens.Number.Nat213.Raw.one
      = E213.Lens.Number.Nat213.Raw.succ (toRaw m) := by
  rw [← toRaw_one, ← toRaw_add, E213.Lens.Number.Nat213.Peano.Nat213.add_one_right, toRaw_succ]

/-- `add_succ_right`: `add m (succ n) = succ (add m n)` (chains).  Layer 2
    의 `add_succ_right` 활용. -/
theorem add_succ_right (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.add (toRaw m)
        (E213.Lens.Number.Nat213.Raw.succ (toRaw n))
      = E213.Lens.Number.Nat213.Raw.succ
          (E213.Lens.Number.Nat213.Raw.add (toRaw m) (toRaw n)) := by
  rw [← toRaw_succ, ← toRaw_add, E213.Lens.Number.Nat213.Peano.Nat213.add_succ_right,
...
private theorem toNat_add (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    (E213.Lens.Number.Nat213.Peano.Nat213.add m n).toNat = m.toNat + n.toNat := by
  induction m with
  | one =>
      -- Layer 2: add one n = succ n.  toNat: 1 + n.toNat.
      show (E213.Lens.Number.Nat213.Peano.Nat213.succ n).toNat = 1 + n.toNat
  ...
  | succ k ih =>
      ...
      show (E213.Lens.Number.Nat213.Peano.Nat213.add k n).toNat + 1
         = (k.toNat + 1) + n.toNat
      rw [ih]
...
theorem value_add (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.value
        (E213.Lens.Number.Nat213.Raw.add (toRaw m) (toRaw n))
      = E213.Lens.Number.Nat213.Raw.value (toRaw m)
      + E213.Lens.Number.Nat213.Raw.value (toRaw n) := by
...
private theorem toNat_mul (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    (E213.Lens.Number.Nat213.Peano.Nat213.mul m n).toNat = m.toNat * n.toNat := by
  induction m with
  | one =>
  ...
  | succ k ih =>
      -- Layer 2: mul (succ k) n = add n (mul k n).
      show (E213.Lens.Number.Nat213.Peano.Nat213.add n
              (E213.Lens.Number.Nat213.Peano.Nat213.mul k n)).toNat
         = (k.toNat + 1) * n.toNat
      rw [toNat_add, ih]
...
/-- **`value (mul m n) = value m * value n`** — Layer 1 곱셈이
    Lean Nat 곱셈과 일치. -/
theorem value_mul (m n : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.value
        (E213.Lens.Number.Nat213.Raw.mul (toRaw m) (toRaw n))
      = E213.Lens.Number.Nat213.Raw.value (toRaw m)
      * E213.Lens.Number.Nat213.Raw.value (toRaw n) := by
...
theorem leavesCountRaw_toRaw (k : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.leavesCountRaw (toRaw k) = toRaw k := by
  induction k with
  | one => rfl
  | succ k' ih =>
      -- toRaw (succ k') = succ (toRaw k'), and toRaw k' ≠ Raw.b
      show E213.Lens.Number.Nat213.Raw.leavesCountRaw
              (E213.Lens.Number.Nat213.Raw.succ (toRaw k'))
         = E213.Lens.Number.Nat213.Raw.succ (toRaw k')
      rw [E213.Lens.Number.Nat213.Raw.leavesCountRaw_succ _ (toRaw_ne_b k'), ih]
...
theorem value_leavesCountRaw (k : E213.Lens.Number.Nat213.Peano.Nat213) :
    E213.Lens.Number.Nat213.Raw.value
        (E213.Lens.Number.Nat213.Raw.leavesCountRaw (toRaw k))
      = E213.Lens.Number.Nat213.Raw.value (toRaw k) := by
...
private theorem fold_chain (t : Tree) :
    ∃ k : E213.Lens.Number.Nat213.Peano.Nat213,
      Tree.fold (α := Raw)
          E213.Lens.Number.Nat213.Raw.one E213.Lens.Number.Nat213.Raw.one
          E213.Lens.Number.Nat213.Raw.add t
        = toRaw k := by
  induction t with
  | a => exact ⟨.one, rfl⟩
  | b => exact ⟨.one, rfl⟩
  | slash x y ihx ihy =>
      obtain ⟨k₁, hk₁⟩ := ihx
      obtain ⟨k₂, hk₂⟩ := ihy
      refine ⟨E213.Lens.Number.Nat213.Peano.Nat213.add k₁ k₂, ?_⟩
      show E213.Lens.Number.Nat213.Raw.add
              (Tree.fold _ _ _ x) (Tree.fold _ _ _ y)
         = toRaw (E213.Lens.Number.Nat213.Peano.Nat213.add k₁ k₂)
      rw [hk₁, hk₂, toRaw_add]

/-- **`leavesCountRaw r` 는 항상 Layer 2 chain image** — 임의 Raw r 위. -/
theorem leavesCountRaw_chain (r : Raw) :
    ∃ k : E213.Lens.Number.Nat213.Peano.Nat213,
      E213.Lens.Number.Nat213.Raw.leavesCountRaw r = toRaw k :=
  fold_chain r.val
...
theorem leavesCountRaw_idempotent (r : Raw) :
    E213.Lens.Number.Nat213.Raw.leavesCountRaw
        (E213.Lens.Number.Nat213.Raw.leavesCountRaw r)
      = E213.Lens.Number.Nat213.Raw.leavesCountRaw r := by
...
theorem value_leavesCountRaw_general (r : Raw) :
    E213.Lens.Number.Nat213.Raw.value (E213.Lens.Number.Nat213.Raw.leavesCountRaw r)
      = E213.Lens.Number.Nat213.Raw.value r :=
...
theorem leavesCountRaw_id_iff_isChain (r : Raw) :
    E213.Lens.Number.Nat213.Raw.leavesCountRaw r = r ↔ IsChain r :=
