import E213.Hypervisor.AxiomLenses.Core.Funext
import E213.Hypervisor.AxiomLenses.Core.Propext
import E213.Hypervisor.AxiomLenses.Core.QuotSound

/-! Spec-as-code entry point for `E213.Hypervisor.AxiomLenses.Core`.
