...
namespace E213.Hypervisor.Lens.Research.Universal.QuotLens
...
end E213.Hypervisor.Lens.Research.Universal.QuotLens
...
theorem universalLens_recovers (α : Type) (M : Lens α)
  ...
  · intro x x' y y' hxy hx'y' hxx' hyy'
    exact E213.Hypervisor.Lens.Research.Kernel.Congruence.Lens.equiv_slash_congruence
