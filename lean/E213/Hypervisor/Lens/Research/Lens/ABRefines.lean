...
import E213.Hypervisor.Lens.Research.Leaves.RefinesParity
...
namespace E213.Hypervisor.Lens.Research.Lens.ABRefines

open E213.Firmware E213.Hypervisor E213.Meta
open E213.Hypervisor.Lens.Research.Lens.AB E213.Hypervisor.Lens.Research.Lens.Factoring
...
theorem abLens_refines_parityLens : abLens.refines parityLens := by
  ...
  intro r
  rw [E213.Hypervisor.Lens.Research.LeavesRefinesParity.parityLens_view_eq_leaves_odd]
  show decide (Lens.leaves.view r % 2 = 1)
       = decide (((abLens.view r).1 + (abLens.view r).2) % 2 = 1)
  rw [abLens_sum_eq_leaves]

end E213.Hypervisor.Lens.Research.Lens.ABRefines
