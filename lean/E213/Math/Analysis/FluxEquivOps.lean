...
namespace E213.Math.Analysis.FluxEquivOps
...
open E213.Math.Analysis.FluxCut.FluxCut (add neg sub ofCut zero)
open E213.Math.Real213.CutPoset (cutEq_refl)
open E213.Math.Analysis.FluxEquiv.FluxCut (cohomEquiv)
...
end E213.Math.Analysis.FluxEquivOps
