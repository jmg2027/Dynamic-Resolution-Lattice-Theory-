...
namespace E213.Math.Analysis.FluxSeries
...
open E213.Math.Analysis.FluxCut.FluxCut (ofCut zero)
open E213.Math.Analysis.CutSeries (partialSum)
open E213.Math.Analysis.CutGeomSeries (geomHalfSeries)
...
end E213.Math.Analysis.FluxSeries
