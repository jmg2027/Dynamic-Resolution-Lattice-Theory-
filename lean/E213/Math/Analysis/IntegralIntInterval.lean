...
namespace E213.Math.Analysis.IntegralIntInterval
...
theorem fluxAlong_id_intInterval (n : Nat) :
    E213.Math.Analysis.FluxCochain.FluxCut.fluxAlong id (intInterval n)
...
theorem integral_one_intInterval (n : Nat) :
    E213.Math.Analysis.IntegralViaAnti.IsAntiderivative.integral E213.Math.Analysis.Antiderivative.IsAntiderivative.id_anti (intInterval n)
      = { forward := constCut n 1, backward := constCut 0 1 } := rfl
...
end E213.Math.Analysis.IntegralIntInterval
