...
Sub-namespaces preserved (cross-layer `open` declarations):
  ...
  * `E213.Math.Analysis.DifferentiableInstances`  — degrees 1-4 + scale/half
...
namespace E213.Math.Analysis.DifferentiableInstances
...
open E213.Math.Analysis.IsSmooth (constIsSmooth cutHalfIsSmooth cutScaleIsSmooth)
...
end E213.Math.Analysis.DifferentiableInstances
...
end E213.Math.Analysis.DifferentiableHigherPow
...
end E213.Math.Analysis.DifferentiableHighOrder
