...
namespace E213.Math.Analysis.IntegralGeneralInt
...
theorem fluxAlong_id_intIntervalAB (a b : Nat) (h : a ≤ b) :
    E213.Math.Analysis.FluxCochain.FluxCut.fluxAlong id (intIntervalAB a b h)
...
theorem integral_one_intIntervalAB (a b : Nat) (h : a ≤ b) :
    E213.Math.Analysis.IntegralViaAnti.IsAntiderivative.integral E213.Math.Analysis.Antiderivative.IsAntiderivative.id_anti (intIntervalAB a b h)
      = { forward := constCut b 1, backward := constCut a 1 } := rfl

/-- ★ Zero-length interval [a, a]: integral balanced. -/
theorem integral_one_intIntervalAA (a : Nat) :
    E213.Math.Analysis.IntegralViaAnti.IsAntiderivative.integral E213.Math.Analysis.Antiderivative.IsAntiderivative.id_anti
...
end E213.Math.Analysis.IntegralGeneralInt
