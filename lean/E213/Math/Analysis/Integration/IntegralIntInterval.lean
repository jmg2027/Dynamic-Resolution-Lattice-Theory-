...
namespace E213.Math.Analysis.Integration.IntegralIntInterval
...
theorem fluxAlong_id_intInterval (n : Nat) :
    E213.Math.Analysis.FluxMVT.FluxCochain.FluxCut.fluxAlong id (intInterval n)
...
end E213.Math.Analysis.Integration.IntegralIntInterval
