...
namespace E213.Math.Analysis.Integration.IntegralGeneralInt
...
theorem fluxAlong_id_intIntervalAB (a b : Nat) (h : a ≤ b) :
    E213.Math.Analysis.FluxMVT.FluxCochain.FluxCut.fluxAlong id (intIntervalAB a b h)
...
theorem integral_one_intIntervalAB (a b : Nat) (h : a ≤ b) :
    E213.Math.Analysis.Integration.IntegralViaAnti.IsAntiderivative.integral E213.Math.Analysis.Integration.Antiderivative.IsAntiderivative.id_anti (intIntervalAB a b h)
      = { forward := constCut b 1, backward := constCut a 1 } := rfl
...
end E213.Math.Analysis.Integration.IntegralGeneralInt
