...
namespace E213.Math.Analysis.FluxMVT.FluxMVTConcrete
...
theorem mvt_id_unitBracket_pure :
    E213.Math.Analysis.FluxMVT.FluxMVT.FluxCut.fluxCutEq
      (localDivergence id unitBracket) (ofCut (constCut 1 1)) :=
  E213.Math.Analysis.FluxMVT.FluxMVT.FluxCut.fluxCutEq_of_pointwise
...
end E213.Math.Analysis.FluxMVT.FluxMVTConcrete
