...
open E213.Math.Analysis.FluxMVT.FluxCut.FluxCut (ofCut zero)
open E213.Math.Analysis.Series.CutSeries (partialSum)
open E213.Math.Analysis.Series.CutGeomSeries (geomHalfSeries)
...
end E213.Math.Analysis.FluxMVT.FluxSeries
