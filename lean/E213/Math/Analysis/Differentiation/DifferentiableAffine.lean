...
namespace E213.Math.Analysis.Differentiation.DifferentiableAffine
...
theorem affineIsDifferentiable_modulus (a b k : Nat) :
  ...
  show max k 0 = k
  exact E213.Math.NatHelpers.Max213.max_eq_left (Nat.zero_le _)
...
theorem squarePlusIdIsDifferentiable_modulus (k : Nat) :
  ...
  exact E213.Math.NatHelpers.Max213.max_eq_left
...
end E213.Math.Analysis.Differentiation.DifferentiableAffine
