...
## Sub-namespaces (preserved for cross-file `open` declarations)
  ...
  * `E213.Math.Analysis.ODELinear`      — first-order: y' = a → y = ax + b
...
open E213.Math.Analysis.IsDifferentiable
  (IsDifferentiable idIsDifferentiable constIsDifferentiable
   addIsDifferentiable)
open E213.Math.Analysis.DifferentiableInstances (cutScaleIsDifferentiable)
...
end E213.Math.Analysis.ODELinear
...
end E213.Math.Analysis.ODECatalog
...
end E213.Math.Analysis.ODESecondOrder
