...
namespace E213.Math.Analysis.IntegralDyadic
...
theorem fluxAlong_id_dyadicAB (numA numB E : Nat) (h : numA ≤ numB) :
    E213.Math.Analysis.FluxCochain.FluxCut.fluxAlong id (dyadicIntervalAB numA numB E h)
...
end E213.Math.Analysis.IntegralDyadic
