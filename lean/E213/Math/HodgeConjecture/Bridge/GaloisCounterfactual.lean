...
namespace E213.Math.HodgeConjecture.Bridge.GaloisCounterfactual

open E213.Physics.Simplex.Counts (binom NS NT)
open E213.Math.HodgeConjecture.Bridge.BeilinsonRegulator (zetaΔ zetaK)
...
end E213.Math.HodgeConjecture.Bridge.GaloisCounterfactual
