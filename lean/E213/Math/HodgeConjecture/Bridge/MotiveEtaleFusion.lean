...
namespace E213.Math.HodgeConjecture.Bridge.MotiveEtaleFusion

open E213.Physics.Simplex.Counts (binom NS NT)
open E213.Math.HodgeConjecture.Bridge.BeilinsonRegulator
  (zetaΔ zetaK regulatorΔ regulatorK)
open E213.Math.HodgeConjecture.Bridge.GaloisCounterfactual
...
end E213.Math.HodgeConjecture.Bridge.MotiveEtaleFusion
