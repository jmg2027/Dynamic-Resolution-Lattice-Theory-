...
namespace E213.Math.HodgeConjecture.Bridge.DiscreteGeometry

open E213.Math.HodgeConjecture.Bridge.Ising
  (Spin mkSpin energy allDown allUp s_1up s_2up s_3up s_4up)
open E213.Math.HodgeConjecture.Bridge.SpinGlass (J_ferro J_anti)
open E213.Math.HodgeConjecture.Bridge.SpinGlassGroundState
  (groundEnergy)
...
end E213.Math.HodgeConjecture.Bridge.DiscreteGeometry
