...
namespace E213.Math.HodgeConjecture.Bridge.PhaseRouting

open E213.Physics.Simplex.Counts (binom NS NT)
open E213.Math.HodgeConjecture.Bridge.BeilinsonRegulator (zetaΔ)
open E213.Math.HodgeConjecture.Bridge.GaloisCounterfactual (fixedCount)
open E213.Math.HodgeConjecture.Bridge.MotiveEtaleFusion
  (motivicDim etaleDim)
...
end E213.Math.HodgeConjecture.Bridge.PhaseRouting
