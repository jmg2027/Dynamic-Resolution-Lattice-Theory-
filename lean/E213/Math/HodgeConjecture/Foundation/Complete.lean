...
namespace E213.Math.HodgeConjecture.Foundation.Complete
...
abbrev HC_Universal : Prop :=
  ∀ {n k m : Nat} (σ : Cochain n k),
    @E213.Math.HodgeConjecture.Foundation.Conjecture.IsHodgeClass n k m σ →
    E213.Math.HodgeConjecture.Foundation.Conjecture.IsAlgebraic σ

/-- (ii) K_{3,2}^{(c=2)} HC²¹³ — every Hodge class is edge-algebraic. -/
abbrev HC_K32 : Prop :=
  ∀ (σ : CochE),
    E213.Math.HodgeConjecture.Foundation.ConjectureLens.IsLensHodgeClass σ →
    E213.Math.HodgeConjecture.Foundation.ConjectureLens.IsEdgeAlgebraic σ
...
theorem hodge_conjecture_213_complete :
  ...
  ⟨@E213.Math.HodgeConjecture.Foundation.Conjecture.hodge_conjecture_213,
   E213.Math.HodgeConjecture.Foundation.ConjectureLens.hodge_conjecture_213_lens,
   E213.Math.Cohomology.Hodge.InvolutionCapstone.hodge_involution_5strata_capstone⟩

end E213.Math.HodgeConjecture.Foundation.Complete
