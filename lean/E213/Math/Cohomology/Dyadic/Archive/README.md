...
root AUDIT_GUIDE.md cleanup roadmap:
  ...
  - `SubwordComplexity.lean` — exploratory complexity measure
    (only used by EdgeSignature)

If any future result needs them, the import path is now:
  `E213.Math.Cohomology.Dyadic.Archive.X`

instead of the old `Dyadic.X`.
