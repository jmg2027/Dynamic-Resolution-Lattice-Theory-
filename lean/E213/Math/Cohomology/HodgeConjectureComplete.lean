...
import E213.Math.Cohomology.Hodge.Conjecture213Lens
import E213.Math.Cohomology.Hodge.RoundTrip
import E213.Math.Cohomology.Hodge.RoundTripMid
import E213.Math.Cohomology.Hodge.LensClassifier
import E213.Math.Cohomology.Hodge.HodgeRing
import E213.Math.Cohomology.Hodge.HodgeMap
import E213.Math.Cohomology.HodgeConjecture213
import E213.Math.Cohomology.HodgeConjectureFilled
import E213.Math.Cohomology.HodgeConjectureLensCata
...
namespace E213.Math.Cohomology.HodgeConjectureComplete
...
abbrev HC_Universal : Prop :=
  ∀ {n k m : Nat} (σ : Cochain n k),
    @E213.Math.Cohomology.Hodge.Conjecture213.IsHodgeClass n k m σ →
    E213.Math.Cohomology.Hodge.Conjecture213.IsAlgebraic σ

/-- (ii) K_{3,2}^{(c=2)} HC²¹³ — every Hodge class is edge-algebraic. -/
abbrev HC_K32 : Prop :=
  ∀ (σ : CochE),
    E213.Math.Cohomology.Hodge.Conjecture213Lens.IsLensHodgeClass σ →
    E213.Math.Cohomology.Hodge.Conjecture213Lens.IsEdgeAlgebraic σ
...
theorem hodge_conjecture_213_complete :
  ...
  ⟨@E213.Math.Cohomology.Hodge.Conjecture213.hodge_conjecture_213,
   E213.Math.Cohomology.Hodge.Conjecture213Lens.hodge_conjecture_213_lens,
   E213.Math.Cohomology.Hodge.InvolutionCapstone.hodge_involution_5strata_capstone⟩

end E213.Math.Cohomology.HodgeConjectureComplete
