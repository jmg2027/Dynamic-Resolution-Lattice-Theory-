...
namespace E213.Math.Cohomology.HodgeConjectureFilled
...
/-- ★★★★★ HC²¹³ extended to filled K_{3,2}^{(c=2)}.  STRICT ∅-AXIOM.
    ...
    See `research-notes/G6_hodge_213_translation.md` §7.B. -/
theorem hodge_conjecture_213_filled :
    ...
    ∧ E213.Math.Cohomology.Hodge.LensClassifier.edgeBasis.length = 12 := by
  decide

end E213.Math.Cohomology.HodgeConjectureFilled
