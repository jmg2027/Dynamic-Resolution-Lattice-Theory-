...
namespace E213.Math.Cohomology.HodgeConjecture.Bridge.PhaseRouting

open E213.Physics.Simplex.Counts (binom NS NT)
open E213.Math.Cohomology.HodgeConjecture.Bridge.BeilinsonRegulator (zetaΔ)
open E213.Math.Cohomology.HodgeConjecture.Bridge.GaloisCounterfactual (fixedCount)
...
end E213.Math.Cohomology.HodgeConjecture.Bridge.PhaseRouting
