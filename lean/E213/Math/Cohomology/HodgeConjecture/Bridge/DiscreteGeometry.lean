...
namespace E213.Math.Cohomology.HodgeConjecture.Bridge.DiscreteGeometry

open E213.Math.Cohomology.HodgeConjecture.Bridge.Ising
  (Spin mkSpin energy allDown allUp s_1up s_2up s_3up s_4up)
open E213.Math.Cohomology.HodgeConjecture.Bridge.SpinGlass (J_ferro J_anti)
...
end E213.Math.Cohomology.HodgeConjecture.Bridge.DiscreteGeometry
