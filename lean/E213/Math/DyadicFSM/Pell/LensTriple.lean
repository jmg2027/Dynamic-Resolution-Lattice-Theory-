import E213.Math.DyadicFSM.Pell.LensPairs
...
namespace E213.Math.DyadicFSM.Pell.LensTriple
...
open E213.Math.DyadicFSM.Pell.Lens (pellLens_3x5_period_20)
open E213.Math.DyadicFSM.ArithFSM.Mod7 (pellFSMmod7)
open E213.Math.DyadicFSM.Pell.LensPairs (pellMod7_BitFSM_bits_period_8)


/-- Inner product (mod 3 × mod 5). -/
def pellInner35 : BitFSM (9 * 25) :=
  E213.Math.DyadicFSM.ProductFSM.BitFSM.product (by decide : (0:Nat) < 25)
...
theorem pellLens_3x5x7_period_40 :
    ∀ k, (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 9 * 25) (m := 49) (by decide)
            pellInner35
            (ArithFSM2.toBitFSM (by decide : 0 < 7) pellFSMmod7)
            xor).bits (k + 40)
        = (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 9 * 25) (m := 49) (by decide)
            pellInner35
            (ArithFSM2.toBitFSM (by decide : 0 < 7) pellFSMmod7)
            xor).bits k := fun k =>
...
end E213.Math.DyadicFSM.Pell.LensTriple
