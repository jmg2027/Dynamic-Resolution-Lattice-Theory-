import E213.Math.DyadicFSM.Pell.Lens
...
namespace E213.Math.DyadicFSM.Pell.LensPairs
...
open E213.Math.DyadicFSM.ProductFSMPeriod (lens_composition_period)
open E213.Math.DyadicFSM.ProductFSMPeriodDvd (lens_composition_period_dvd)
open E213.Math.DyadicFSM.ArithFSM.ToBitFSM (toBitFSM_bits_eq)
...
theorem pellLens_3x7_period_8 :
    ∀ k, (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 9) (m := 49) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 3) pellFSMmod3)
            (ArithFSM2.toBitFSM (by decide : 0 < 7) pellFSMmod7)
            xor).bits (k + 8)
        = (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 9) (m := 49) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 3) pellFSMmod3)
            (ArithFSM2.toBitFSM (by decide : 0 < 7) pellFSMmod7)
            xor).bits k := fun k =>
...
theorem pellLens_5x7_period_40 :
    ∀ k, (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 25) (m := 49) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 5) pellFSMmod5)
            (ArithFSM2.toBitFSM (by decide : 0 < 7) pellFSMmod7)
            xor).bits (k + 40)
        = (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 25) (m := 49) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 5) pellFSMmod5)
            (ArithFSM2.toBitFSM (by decide : 0 < 7) pellFSMmod7)
            xor).bits k := fun k =>
...
end E213.Math.DyadicFSM.Pell.LensPairs
