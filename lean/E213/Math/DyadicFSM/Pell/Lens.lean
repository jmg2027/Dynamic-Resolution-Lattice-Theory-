...
Compose the Pell ArithFSM2 instances via E213.Math.DyadicFSM.ProductFSM.BitFSM.product.
...
namespace E213.Math.DyadicFSM.Pell.Lens
...
open E213.Math.DyadicFSM.ArithFSM (pellFSMmod3_bits_period_4)
...
theorem pellLens_3x5_period_20 :
    ∀ k, (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 9) (m := 25) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 3) pellFSMmod3)
            (ArithFSM2.toBitFSM (by decide : 0 < 5) pellFSMmod5)
            xor).bits (k + 20)
        = (E213.Math.DyadicFSM.ProductFSM.BitFSM.product (n := 9) (m := 25) (by decide)
            (ArithFSM2.toBitFSM (by decide : 0 < 3) pellFSMmod3)
            (ArithFSM2.toBitFSM (by decide : 0 < 5) pellFSMmod5)
            xor).bits k := fun k =>
...
end E213.Math.DyadicFSM.Pell.Lens
