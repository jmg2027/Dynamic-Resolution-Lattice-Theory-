...
theorem tribMod2_BitFSM_bits_period_4 :
    ∀ k, (E213.Math.DyadicFSM.ArithFSM.V3toBitFSM.ArithFSM3.toBitFSM
            (by decide : (0:Nat) < 2) tribFSMmod2).bits (k + 4)
        = (E213.Math.DyadicFSM.ArithFSM.V3toBitFSM.ArithFSM3.toBitFSM
...
end E213.Math.DyadicFSM.CrossClassLens
