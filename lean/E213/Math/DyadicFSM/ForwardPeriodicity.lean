...
namespace E213.Math.DyadicFSM.ForwardPeriodicity
...
theorem encode_inj {p : Nat} (hp : 0 < p)
  ...
  have ha : (a * p + r1) / p = a := E213.Math.NatHelpers.EncodePair213.encode_div hp a r1 h1
  have hb : (b * p + r2) / p = b := E213.Math.NatHelpers.EncodePair213.encode_div hp b r2 h2
  have hra : (a * p + r1) % p = r1 := E213.Math.NatHelpers.EncodePair213.encode_mod hp a r1 h1
  have hrb : (b * p + r2) % p = r2 := E213.Math.NatHelpers.EncodePair213.encode_mod hp b r2 h2
...
end E213.Math.DyadicFSM.ForwardPeriodicity
