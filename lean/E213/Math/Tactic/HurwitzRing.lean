...
scoped macro "hurwitz_ring" : tactic => `(tactic|
  ((try apply E213.Math.CayleyDickson.Pathion.ext) <;>
   ...
   simp only [
     ...
     E213.Math.CayleyDickson.Pathion.conj_re, E213.Math.CayleyDickson.Pathion.conj_im,
     E213.Math.CayleyDickson.Pathion.add_re, E213.Math.CayleyDickson.Pathion.add_im,
     E213.Math.CayleyDickson.Pathion.sub_re, E213.Math.CayleyDickson.Pathion.sub_im,
     E213.Math.CayleyDickson.Pathion.neg_re, E213.Math.CayleyDickson.Pathion.neg_im,
     E213.Math.CayleyDickson.Pathion.zero_re, E213.Math.CayleyDickson.Pathion.zero_im,
     E213.Math.CayleyDickson.Trigintaduonion.mul_re, E213.Math.CayleyDickson.Trigintaduonion.mul_im,
     E213.Math.CayleyDickson.Trigintaduonion.conj_re, E213.Math.CayleyDickson.Trigintaduonion.conj_im,
     E213.Math.CayleyDickson.Trigintaduonion.add_re, E213.Math.CayleyDickson.Trigintaduonion.add_im,
     E213.Math.CayleyDickson.Trigintaduonion.sub_re, E213.Math.CayleyDickson.Trigintaduonion.sub_im,
     E213.Math.CayleyDickson.Trigintaduonion.neg_re, E213.Math.CayleyDickson.Trigintaduonion.neg_im,
     E213.Math.CayleyDickson.Trigintaduonion.zero_re, E213.Math.CayleyDickson.Trigintaduonion.zero_im,
     E213.Math.CayleyDickson.Sedenion.mul_re, E213.Math.CayleyDickson.Sedenion.mul_im,
     E213.Math.CayleyDickson.Sedenion.conj_re, E213.Math.CayleyDickson.Sedenion.conj_im,
     E213.Math.CayleyDickson.Sedenion.add_re, E213.Math.CayleyDickson.Sedenion.add_im,
     E213.Math.CayleyDickson.Sedenion.sub_re, E213.Math.CayleyDickson.Sedenion.sub_im,
     E213.Math.CayleyDickson.Sedenion.neg_re, E213.Math.CayleyDickson.Sedenion.neg_im,
     E213.Math.CayleyDickson.Sedenion.zero_re, E213.Math.CayleyDickson.Sedenion.zero_im,
     E213.Math.CayleyDickson.Cayley.mul_re, E213.Math.CayleyDickson.Cayley.mul_im,
     E213.Math.CayleyDickson.Cayley.conj_re, E213.Math.CayleyDickson.Cayley.conj_im,
     E213.Math.CayleyDickson.Cayley.add_re, E213.Math.CayleyDickson.Cayley.add_im,
     ...
     E213.Math.CayleyDickson.ZI.sub_re, E213.Math.CayleyDickson.ZI.sub_im,
     E213.Math.CayleyDickson.ZI.neg_re, E213.Math.CayleyDickson.ZI.neg_im,
     E213.Math.CayleyDickson.ZI.I_re, E213.Math.CayleyDickson.ZI.I_im,
     E213.Math.CayleyDickson.ZI.negI_re, E213.Math.CayleyDickson.ZI.negI_im,
     E213.Math.CayleyDickson.ZI.re_zero, E213.Math.CayleyDickson.ZI.im_zero,
