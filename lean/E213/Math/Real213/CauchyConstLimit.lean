...
theorem CauchyCutSeq.cutDouble_cutSum_limit (a b : CauchyCutSeq) :
  ...
  exact (E213.Math.Real213.CutSum.cutDouble_cutSum _ _).symm
...
theorem CauchyCutSeq.cutMid_limit (a b : CauchyCutSeq) :
    (a.cutMid b).limit = E213.Math.Real213.CutSum.cutMid a.limit b.limit := by
  show (a.cutSum b).cutHalf.limit
       = E213.Math.Real213.CutSum.cutHalf (E213.Math.Real213.CutSum.cutSum a.limit b.limit)
  rw [CauchyCutSeq.cutHalf_limit, CauchyCutSeq.cutSum_limit]

end E213.Math.Real213.CauchyConstLimit
