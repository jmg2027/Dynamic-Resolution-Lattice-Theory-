...
| degree   | namespace                                                                            |
|----------|--------------------------------------------------------------------------------------|
| 2, 3     | `E213.Math.Real213.FluxMVTPolynomial`  (square + cube)                               |
| 4        | `E213.Math.Real213.FluxMVTHigh`        (quartic)                                     |
| `n + 1`  | `E213.Math.Real213.FluxMVTGeneric`     (any polynomial degree, single proof for all) |
