...
## Three axes (sub-namespaces preserved)
  ...
  * `E213.Math.Real213.Antiderivative`            — definition + atomic instances
  * `E213.Math.Real213.AntiderivativeCombinators` — mid / add / mul combinators
  * `E213.Math.Real213.AntiderivativeStructural`  — every IsDifferentiable yields one
