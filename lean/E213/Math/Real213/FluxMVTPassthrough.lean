...
Sub-namespaces preserved (cross-file `open` declarations stay valid):
  ...
  * `E213.Math.Real213.FluxMVTPassthrough`   — the general theorem
  * `E213.Math.Real213.FluxMVTClosure`       — closure under combinators
  * `E213.Math.Real213.FluxMVTApplications`  — corollaries for id / cutPow / x² / x³
