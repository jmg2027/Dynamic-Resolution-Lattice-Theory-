...
namespace E213.Physics.AtomicBridge

/-- Bohr denom = NT = 2. -/
theorem bohr_atomic :
    E213.Physics.Hydrogen.bohr_denom = 2 := by decide

/-- n=1 hydrogen prefactor = NT·1² = 2. -/
theorem n1_atomic :
    E213.Physics.Hydrogen.n1_prefactor_denom = 2 := by decide

/-- n=2 hydrogen prefactor = NT·2² = 8. -/
theorem n2_atomic :
    E213.Physics.Hydrogen.n2_prefactor_denom = 8 := by decide

/-- σ_p2 screening = NS/(NS+1) = 3/4. -/
theorem sigma_p2_atomic :
    E213.Physics.AtomicScreening.sigma_p2_num = 3
    ∧ E213.Physics.AtomicScreening.sigma_p2_den = 4 := by decide

/-- σ_p3 screening = NT/(NT+1) = 2/3. -/
theorem sigma_p3_atomic :
    E213.Physics.AtomicScreening.sigma_p3_num = 2
    ∧ E213.Physics.AtomicScreening.sigma_p3_den = 3 := by decide
...
theorem atomic_bridge_capstone :
    ...
    ∧ E213.Physics.Hydrogen.n2_prefactor_denom = 8
    ∧ E213.Physics.AtomicScreening.sigma_p2_num = 3
    ∧ E213.Physics.AtomicScreening.sigma_p2_den = 4
    ∧ E213.Physics.AtomicScreening.sigma_p3_num = 2 := by decide

end E213.Physics.AtomicBridge
