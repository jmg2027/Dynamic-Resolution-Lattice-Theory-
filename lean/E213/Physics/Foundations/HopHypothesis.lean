...
theorem strong_inv_coupling : E213.Physics.AlphaEM.Bare.inv_alpha_3 = 8 := by decide

/-- α_2 weak: 1/α_2 = 12·NT·S(NT) = 30. -/
theorem weak_inv_coupling : E213.Physics.AlphaEM.Bare.inv_alpha_2 = 30 := by decide
...
theorem hop_hypothesis_capstone :
    ...
    (alpha_3_Neff = 1
     ∧ S 1 = (1, 1)
     ∧ E213.Physics.AlphaEM.Bare.inv_alpha_3 = 8
     ∧ (8 : Nat) = NS * NS - 1)
    -- Weak: depth=NT=2, S(2)=5/4, 1/α_2=30
    ∧ (alpha_2_Neff = 2
       ∧ S 2 = (5, 4)
       ∧ E213.Physics.AlphaEM.Bare.inv_alpha_2 = 30
       ∧ (30 : Nat) = 12 * NT * 5 / 4)
