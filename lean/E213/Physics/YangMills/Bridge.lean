...
namespace E213.Physics.YangMills.Bridge
...
theorem ym_unified_diamond :
    ...
    ∧ E213.Physics.Simplex.Counts.d = 5 := by
  refine ⟨E213.Physics.Couplings.PhotonKernel.b_1_eq_8, ?_, ?_, ?_, ?_⟩
  all_goals decide
...
end E213.Physics.YangMills.Bridge
