...
/-!
  ...
  Upper bracket converges to (10π² + 30 + 25/3) ≈ 137.029.
  Observed 1/α_em ≈ 137.036 — the gap 0.007 is the α_GUT/(NS+1)
  Dyson-tail term not in this five-term sum.

  Consolidation note (2026-05-05): formerly `V137Tighter.lean`.
  Merged as strict-extension companion to the N=10 bracket above;
