...
Sub-namespaces (preserved for cross-layer `open`):
  ...
  * `E213.Physics.AlphaEM.BareTightBracket` — bare 60·ζ(2)+30 ≈ 128.696
  * `E213.Physics.AlphaEM.V137`             — candidate 60·ζ(2)+30+25/3 ≈ 137.029
  * `E213.Physics.AlphaEM.V137Tight`        — telescoped lower (S(N)+1/(N+1))
