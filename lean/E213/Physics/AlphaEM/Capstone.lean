...
Sub-namespaces (preserved for `open` declarations across layers):
  ...
  * `E213.Physics.AlphaEM.UnifiedSum`        — three-force + 1/NS + Dyson tail
  * `E213.Physics.AlphaEM.SimplicialDecomp`  — five-term cohomology origin
  * `E213.Physics.AlphaEM.MasterCapstone`    — finitist closure with N_U
  * `E213.Physics.AlphaEM.MilestoneAt137`    — |x − 137.036| < 1/10⁴ witness
