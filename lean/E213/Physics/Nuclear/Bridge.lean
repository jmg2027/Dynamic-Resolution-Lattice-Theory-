...
namespace E213.Physics.NuclearBridge

/-- a_V (volume coefficient) = NS·NT = 6 = d+1. -/
theorem a_V_atomic :
    E213.Physics.Nuclear.a_V_coef = 6
    ∧ (3 * 2 : Nat) = 6
    ∧ (5 + 1 : Nat) = 6 := by decide

/-- a_S (surface coefficient) = d-1 = 4 = NS+1. -/
theorem a_S_atomic :
    E213.Physics.Nuclear.a_S_coef = 4
    ∧ (5 - 1 : Nat) = 4
    ∧ (3 + 1 : Nat) = 4 := by decide

/-- a_C (Coulomb) num/den = NS/d = 3/5. -/
theorem a_C_atomic :
    E213.Physics.Nuclear.a_C_coef_num = 3
    ∧ E213.Physics.Nuclear.a_C_coef_den = 5 := by decide
...
theorem magic_atomic :
    ...
    ∧ E213.Physics.Magic.ho_magic 3 = 20 := by decide
...
end E213.Physics.NuclearBridge
