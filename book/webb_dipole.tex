...
This is testable: molecular hydrogen lines in the same quasar spectra can probe $\alpha_s$ (through the proton-to-electron mass ratio $\mu = m_p/m_e$, which depends on $\Lambda_\text{QCD}$, which depends on $\alpha_s$).

\textbf{If $\Delta\alpha_\text{em}$ and $\Delta\mu$ have the same sign, DRLT is falsified.}
