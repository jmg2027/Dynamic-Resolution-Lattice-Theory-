...
The combinatorial formulas (Sections above) give median accuracy $\sim 3\%$.  Including the $\det(G_h)$ geometric contributions (Chapter~\ref{ch:ghosts}) with the universal correction pattern $\text{Leading} \times (1 + \alpha_\mathrm{GUT} \times f_\mathrm{sector})$, all masses improve to $< 0.2\%$:
