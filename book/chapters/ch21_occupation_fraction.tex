...
\begin{equation}
\boxed{\sqrt{2\lambda} = f_\mathrm{occ} \times V(x_H) = \frac{1 + \agut}{c},
\qquad
\lambda = \frac{(1 + \agut)^2}{2c^2} \approx 0.1312.}
\end{equation}
The Higgs mass follows: $m_H = v_H\sqrt{2\lambda} = v_H(1+\agut)/c \approx 125.9\;\mathrm{GeV}$, in $0.5\%$ agreement with the observed $125.25 \pm 0.17\;\mathrm{GeV}$.
\end{theorem}
