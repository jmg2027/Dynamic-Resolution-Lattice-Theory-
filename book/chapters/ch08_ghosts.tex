...
\begin{remark}[Topology, not corrections]
The combinatorial values ($8, 30, 6\pi^2$ for the couplings) are the ``skeleton'' of the full answer. The $\det(G_h)$ contributions are the ``flesh.'' Together they form the complete topological calculation. What earlier versions of this work called ``ghost corrections'' are simply the second half of the topology --- the hinge areas $A_h = \sqrt{\det(G_h)}$ that the Regge action $S = \sum A_h\,\delta_h$ requires.
\end{remark}
