...
At each order $k$, the correction satisfies $\sum_i \delta^{(k)}_i = 0$ (zero-sum from trace conservation).  Higher-order corrections scale as $\alpha_\mathrm{GUT}^k \sim (1/41)^k$, giving geometric convergence.
\end{theorem}
