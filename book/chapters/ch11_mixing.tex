...
\begin{equation}
m_H = v_H\,\frac{1+\alpha_\text{GUT}}{c} = 245.8 \times \frac{1.0243}{2} \approx 125.9\;\text{GeV}.
\end{equation}
Observed: $125.25 \pm 0.17\;\text{GeV}$ ($+0.5\%$).  The quartic coupling $\lambda = (1+\alpha_\text{GUT})^2/(2c^2) \approx 0.131$ is derived from the face-level Binet--Cauchy decomposition (Section~\ref{sec:higgs_quartic}).
...
18 & $m_H$ & 125.9 GeV & 125.25 & $v_H(1\!+\!\alpha_\text{GUT})/c$ \\
\hline
