...
$<5\%$ error & 81 & 69\% \\
$<10\%$ error & 105 & 89\% \\
Median error & \multicolumn{2}{c}{$3.1\%$} \\
\hline
\end{tabular}
\end{center}

All 118 elements, zero free parameters, median $3.1\%$.  Period 1--2 errors are below $3\%$; period 3--5 below $5\%$; periods 6--7 below $10\%$ (with known exceptions at $f\!\to\!d$ transitions and relativistic elements).
