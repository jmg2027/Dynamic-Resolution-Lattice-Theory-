...
The exponential form follows from the Wishart eigenvalue distribution of the Gram matrix: each independent compression mode contributes a multiplicative factor $e^{-\Delta\rho/\rho_\text{sat}}$.
