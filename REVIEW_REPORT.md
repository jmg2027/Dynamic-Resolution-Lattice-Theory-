...
| ~~9~~ | temporal weighting 설명 | ✅ ch05 c^k 스케일링 설명 추가 |
| ~~10~~ | CP phase 검증 참조 | ✅ ch07에 EXP_019 참조 추가 |

**10/10 전부 해결.**

---

## 8. EXP_043 시리즈: 심플렉스 원자 물리

| 실험 | 결과 |
|------|------|
| 043: 심플렉스 해부 | H/He/H₂/Li/Be det 계산, 그림 생성 |
| 043b: 전 원소 | 118개, 힌지=1+9Z, 0.5초 |
| 043c: Shell 구조 | hop=n, 용량=2n², He/Ne peak ✓ |
| **043d: Madelung** | **score=1/(n+l)² → 19/19 완벽 일치** |
| 043e: IE (1/(n+l)²) | 순서 맞음, 크기 83% 오차 |
| 043f: Slater σ | 구조 맞음, det 값 비물리적 |
| 043g-j: Gram det IE | rank≤5 한계, 38% 오차 (P -5%, As +1%) |

**핵심 성과: Madelung rule = simplex topology. 변분 없이 유도.**
