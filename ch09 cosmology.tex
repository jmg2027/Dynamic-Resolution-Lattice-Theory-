...
Dark matter is \emph{not a new particle}. It is the gravitational effect of the ZPE of vacuum vertices --- vertices that are not part of any baryonic structure but still carry energy through their $W_{ij} > 0$ connections.
...
All quantities involve zero free parameters. The three sharpest predictions --- $r \approx 0.003$, $\tau_p \approx 10^{34}\;\text{yr}$, and $w = -1$ exactly --- are testable within the next decade.
