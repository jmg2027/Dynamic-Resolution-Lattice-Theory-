...
impl RewriteRule for NsMulNtEqSix {
    const LEAN_THM: &'static str = "E213.Kernel.MonomialAxioms.ns_mul_nt_eq_six";
    fn lhs() -> Expr { mul(x(), y()) }
    fn rhs() -> Expr { k(6) }
}
...
impl RewriteRule for MulCommNsNt {
    const LEAN_THM: &'static str = "E213.Kernel.MonomialAxioms.mul_comm_ns_nt";
    fn lhs() -> Expr { mul(x(), y()) }
    fn rhs() -> Expr { mul(y(), x()) }
}
...
impl RewriteRule for NsSqEq9 {
    const LEAN_THM: &'static str = "E213.Kernel.MonomialAxioms.ns_sq_eq_9";
    fn lhs() -> Expr { pow(x(), 2) }
    fn rhs() -> Expr { k(9) }
}
...
impl RewriteRule for NtSqEq4 {
    const LEAN_THM: &'static str = "E213.Kernel.MonomialAxioms.nt_sq_eq_4";
    fn lhs() -> Expr { pow(y(), 2) }
    fn rhs() -> Expr { k(4) }
}
...
impl RewriteRule for DSqEq25 {
    const LEAN_THM: &'static str = "E213.Kernel.MonomialAxioms.d_sq_eq_25";
