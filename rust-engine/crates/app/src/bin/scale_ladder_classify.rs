...
const ROWS: &[Row] = &[
    ...
    Row { scale: "nucleus",    obs: "g_p ≈ NS²/d·ζ(2)²·(1+6α) (828 ppm)", class: "B+C",
          form: "(9/5)·ζ(2)²·(1+NS·NT·α)", lean: "ProtonG.g_p_atomic_skeleton" },
    ...
    Row { scale: "lepton",     obs: "Koide Q = NT/NS = 2/3 (9.3 ppm)", class: "C",
          form: "atomic ratio direct, 45° geometric",
          lean: "KoideFormula.koide_atomic" },
