...
fn cases() -> Vec<DiffCase> {
    vec![
        ...
        DiffCase {
            ...
            lean_expr: "E213.Physics.AlphaEM.V137.inv_full_lower",
        ...
        DiffCase {
            ...
            lean_module: "E213.Physics.AlphaEM.V137",
            lean_expr: "E213.Physics.AlphaEM.V137.inv_full_upper",
        ...
        DiffCase {
            ...
            lean_expr: "E213.Physics.AlphaEM.V137Tight.inv_lower_tight",
        ...
        DiffCase {
            ...
            lean_expr: "E213.Physics.AlphaEM.WithTail.inv_lower_with_tail",
        ...
        DiffCase {
            ...
            lean_module: "E213.Physics.AlphaEM.WithTail",
            lean_expr: "E213.Physics.AlphaEM.WithTail.inv_upper_with_tail",
        ...
        DiffCase {
            ...
            lean_expr: "E213.Physics.AlphaEM.SO10.inv_lower_so10",
        ...
        DiffCase {
            ...
            lean_module: "E213.Physics.AlphaEM.SO10",
            lean_expr: "E213.Physics.AlphaEM.SO10.inv_upper_so10",
        ...
        DiffCase {
            ...
            lean_expr: "E213.Physics.AlphaEM.GramSelfEnergy.inv_lower_aug",
        ...
        DiffCase {
            ...
            lean_module: "E213.Physics.AlphaEM.GramSelfEnergy",
            lean_expr: "E213.Physics.AlphaEM.GramSelfEnergy.inv_upper_aug",
