...
## ★★ CURRENT STATE (2026-06-22, 37-wave multi-agent marathon) — read `research-notes/decomposition/SYNTHESIS.md` FIRST
The decomposition-calculus program (the originator's recalibrated central direction — see RECALIBRATION below)
now spans **120 worked decompositions** (past the century mark) of mathematical fields, all reading through `OBJECT = ⟨C|L⟩ ⊕ Residue`,
...
gap).  SYNTHESIS at **v4 (count 120)**.  **Five calibrated boundaries** now located
