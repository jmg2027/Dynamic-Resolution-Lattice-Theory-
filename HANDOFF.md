...
| **FW-1 signed Donaldson count** | **SUPERSEDED by G126** | Original blocker: meta-research at the 213/standard-math boundary.  Akbulut cork theorem (Freedman-Akbulut-Curtis-Hsiang-Stong) provides a discrete Z/2 alternative that's fully 213-internal: cork = (contractible substructure + Z/2 involution), cork-twist gives natural sign grading on Sym(3)-orbits.  All ingredients (M_S01 involution, K_{1,4} tree, ∂Δ⁴ = S³, tree-critical coexistence) pre-exist.  See `research-notes/G126_akbulut_cork_213_native.md`. |
| **G126 Akbulut cork as 213-native exotic-structure framework** | **NEW HIGH-PRIORITY** | `research-notes/G126_akbulut_cork_213_native.md` — ~120 PURE est., 8-12 sessions, 6-phase plan under `lean/E213/Lib/Math/AkbulutCork/`.  Converts the FW-1 sign problem into a concrete 213-internal cork-twist enumeration.  Strongest current path toward DRLT Validation Standard for G121. |
