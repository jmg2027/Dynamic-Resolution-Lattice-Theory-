...
**Open pieces** (two, identified explicitly):
  · **Direction B** — extend ψ-kills of star/incidence cup-products
    from bottom layer to all layers (Nat.beq cancellation across
    `9·m` offsets).  Closes the SOUNDNESS hypotheses of
