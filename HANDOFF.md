...
## ★★ CURRENT STATE (2026-06-22, 36-wave multi-agent marathon) — read `research-notes/decomposition/SYNTHESIS.md` FIRST
The decomposition-calculus program (the originator's recalibrated central direction — see RECALIBRATION below)
now spans **117 worked decompositions** (past the century mark) of mathematical fields, all reading through `OBJECT = ⟨C|L⟩ ⊕ Residue`,
...
gap).  SYNTHESIS at **v3 (count 117)**.  **Five calibrated boundaries** now located
