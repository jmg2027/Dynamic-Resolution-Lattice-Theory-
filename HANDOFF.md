...
## ★★ CURRENT STATE (2026-06-22, 40-wave multi-agent marathon) — read `research-notes/decomposition/SYNTHESIS.md` FIRST
The decomposition-calculus program (the originator's recalibrated central direction — see RECALIBRATION below)
now spans **129 worked decompositions** (past the century mark) of mathematical fields, all reading through `OBJECT = ⟨C|L⟩ ⊕ Residue`,
...
gap).  SYNTHESIS at **v4 (count 129)**.  **Five calibrated boundaries** now located
