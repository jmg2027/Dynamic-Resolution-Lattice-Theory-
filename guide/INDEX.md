...
|---|---------|------|---------------|--------------|---------------|
| 00 | Meta — what 213 is | T0 | n/a (foundation) | Firmware/Raw, OS/Atomicity | paper14, drlt-book ch22 |
| 01 | Substrate — Raw to ℂ-like | T0/T3 | n/a (axiom + classical) | Firmware/Raw, Meta/R4Codomain | paper1, paper2, ch01 |
| 02 | Atomicity — d=5, NS=3, NT=2, Fibonacci | T0 | passing (theorem) | OS/Atomicity, Physics/FibonacciAtomic | paper1, ch02-ch03 |
| 03 | Simplex geometry & hinges | T1 | passing | Physics/SimplexCounts, Physics/FaceTerms | paper6, ch04-ch06 |
| 04 | Quantization (ℏ, atomic spacing) | T1 | partial | Physics/Phase4 | ch07 |
| 05 | Coupling constants (α_GUT, α_em, α_3) | T2 | partial (bracket only) | Physics/AlphaGUT, AlphaEM137 | paper2, paper4, paper6, ch08 |
| 06 | Mass spectrum (lepton, quark, Higgs) | T2/T1 | passing for m_μ/m_e, m_p, m_H | Physics/MuOverE, ProtonMass, HiggsMass | ch09 |
| 07 | Atomic structure & periodic table | T1 | passing for Z=1..118 | Physics/Phase4/Library/* | ch10, ch20 |
...
1. IE_H = m_e·c²·α²/2 → 4.3 ppb closed (Physics/Phase4/HydrogenIEPPM)
2. m_μ/m_e → 0.48 ppb closed (Physics/MuOverE)
3. m_p → 0.000% closed (Physics/ProtonMass)
4. Ω_Λ → 0.0008% closed (Physics/DarkEnergy)
5. Magic numbers 7/7 → exact closed (Physics/MagicNumbers)
6. Periodic table Z=1..118 → ppb-level closed (Phase4/Library)
7. d=5 atomicity → exact theorem (OS/Atomicity)
