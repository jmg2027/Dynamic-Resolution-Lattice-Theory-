...
`E213.Lib.Math.NumberSystems.Real213.RateStratification` — **26 PURE / 0 DIRTY**.
...
The forward additive-cancel used the PURE
...
`E213.Lib.Math.NumberSystems.Real213.Zeta3Cut` — **35 PURE / 0 DIRTY**.  ★★★ **ζ(3) as a
